...
import {ROM, DISK1, DISK2} from "./dist/the_fairyland_story_x68_rom.js";
...
window.addEventListener('load', () => expand(ROM).then(ROM => {
	...
	canvas.addEventListener('click', () => void game.keyboard.fifo.push(0x2a, 0x80 | 0x2a));
