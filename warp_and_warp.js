...
//			this.ram[0xc01] = 0xff; // 2P
	...
	makeBitmap(data) {
		...
		for (let i = 0; i < 4; i++) {
			data[p] = data[p + 1] = data[p + 2] = data[p + 3] = this.rgb[0xf6];
			p += 256;
			if (p >= 256 * 8 * 35)
				p -= 256 * 8 * 32;
		}
	...
	xfer8x8(data, p, k) {
		const q = this.ram[k] << 6;
		const color = this.rgb[this.ram[k + 0x400]];

		data[p + 0x000] = color & this.bg[q + 0x00];
		data[p + 0x001] = color & this.bg[q + 0x01];
		data[p + 0x002] = color & this.bg[q + 0x02];
		data[p + 0x003] = color & this.bg[q + 0x03];
		data[p + 0x004] = color & this.bg[q + 0x04];
		data[p + 0x005] = color & this.bg[q + 0x05];
		data[p + 0x006] = color & this.bg[q + 0x06];
		data[p + 0x007] = color & this.bg[q + 0x07];
		data[p + 0x100] = color & this.bg[q + 0x08];
		data[p + 0x101] = color & this.bg[q + 0x09];
		data[p + 0x102] = color & this.bg[q + 0x0a];
		data[p + 0x103] = color & this.bg[q + 0x0b];
		data[p + 0x104] = color & this.bg[q + 0x0c];
		data[p + 0x105] = color & this.bg[q + 0x0d];
		data[p + 0x106] = color & this.bg[q + 0x0e];
		data[p + 0x107] = color & this.bg[q + 0x0f];
		data[p + 0x200] = color & this.bg[q + 0x10];
		data[p + 0x201] = color & this.bg[q + 0x11];
		data[p + 0x202] = color & this.bg[q + 0x12];
		data[p + 0x203] = color & this.bg[q + 0x13];
		data[p + 0x204] = color & this.bg[q + 0x14];
		data[p + 0x205] = color & this.bg[q + 0x15];
		data[p + 0x206] = color & this.bg[q + 0x16];
		data[p + 0x207] = color & this.bg[q + 0x17];
		data[p + 0x300] = color & this.bg[q + 0x18];
		data[p + 0x301] = color & this.bg[q + 0x19];
		data[p + 0x302] = color & this.bg[q + 0x1a];
		data[p + 0x303] = color & this.bg[q + 0x1b];
		data[p + 0x304] = color & this.bg[q + 0x1c];
		data[p + 0x305] = color & this.bg[q + 0x1d];
		data[p + 0x306] = color & this.bg[q + 0x1e];
		data[p + 0x307] = color & this.bg[q + 0x1f];
		data[p + 0x400] = color & this.bg[q + 0x20];
		data[p + 0x401] = color & this.bg[q + 0x21];
		data[p + 0x402] = color & this.bg[q + 0x22];
		data[p + 0x403] = color & this.bg[q + 0x23];
		data[p + 0x404] = color & this.bg[q + 0x24];
		data[p + 0x405] = color & this.bg[q + 0x25];
		data[p + 0x406] = color & this.bg[q + 0x26];
		data[p + 0x407] = color & this.bg[q + 0x27];
		data[p + 0x500] = color & this.bg[q + 0x28];
		data[p + 0x501] = color & this.bg[q + 0x29];
		data[p + 0x502] = color & this.bg[q + 0x2a];
		data[p + 0x503] = color & this.bg[q + 0x2b];
		data[p + 0x504] = color & this.bg[q + 0x2c];
		data[p + 0x505] = color & this.bg[q + 0x2d];
		data[p + 0x506] = color & this.bg[q + 0x2e];
		data[p + 0x507] = color & this.bg[q + 0x2f];
		data[p + 0x600] = color & this.bg[q + 0x30];
		data[p + 0x601] = color & this.bg[q + 0x31];
		data[p + 0x602] = color & this.bg[q + 0x32];
		data[p + 0x603] = color & this.bg[q + 0x33];
		data[p + 0x604] = color & this.bg[q + 0x34];
		data[p + 0x605] = color & this.bg[q + 0x35];
		data[p + 0x606] = color & this.bg[q + 0x36];
		data[p + 0x607] = color & this.bg[q + 0x37];
		data[p + 0x700] = color & this.bg[q + 0x38];
		data[p + 0x701] = color & this.bg[q + 0x39];
		data[p + 0x702] = color & this.bg[q + 0x3a];
		data[p + 0x703] = color & this.bg[q + 0x3b];
		data[p + 0x704] = color & this.bg[q + 0x3c];
		data[p + 0x705] = color & this.bg[q + 0x3d];
		data[p + 0x706] = color & this.bg[q + 0x3e];
		data[p + 0x707] = color & this.bg[q + 0x3f];
	}
}
