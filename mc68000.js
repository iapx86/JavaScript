...
//		this.ssp = 0;
	...
	execute_0(op) {
		...
		case 0o006: // ORI.B #<data>,d(An,Xi)
			this.rwop8(op, this.or8, this.fetch16());
			break;
		case 0o007:
			switch (op & 7) {
		...
		case 0o026: // ORI.L #<data>,d(An,Xi)
			this.rwop32(op, this.or32, this.fetch32());
			break;
		...
		case 0o040: // BTST D0,Dn
			this.btst32(this.d0, this.rop32(op));
			break;
		case 0o041: // MOVEP.W d(Ay),D0
			this.d0 = this.d0 & ~0xffff | this.movep(op);
			break;
		...
		case 0o056: // BCHG D0,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d0);
			break;
		...
		case 0o060: // BCLR D0,Dn
			this.rwop32(op, this.bclr32, this.d0);
			break;
		case 0o061: // MOVEP.W D0,d(Ay)
			this.movep(op, this.d0);
			break;
		...
		case 0o066: // BCLR D0,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d0);
			break;
		...
		case 0o070: // BSET D0,Dn
			this.rwop32(op, this.bset32, this.d0);
			break;
		...
		case 0o076: // BSET D0,d(An,Xi)
			this.rwop8(op, this.bset8, this.d0);
			break;
		...
		case 0o106: // ANDI.B #<data>,d(An,Xi)
			this.rwop8(op, this.and8, this.fetch16());
			break;
		case 0o107:
			switch (op & 7) {
		...
		case 0o126: // ANDI.L #<data>,d(An,Xi)
			this.rwop32(op, this.and32, this.fetch32());
			break;
		...
		case 0o140: // BTST D1,Dn
			this.btst32(this.d1, this.rop32(op));
			break;
		case 0o141: // MOVEP.W d(Ay),D1
			this.d1 = this.d1 & ~0xffff | this.movep(op);
			break;
		...
		case 0o146: // BTST D1,d(An,Xi)
			this.btst8(this.d1, this.rop8(op));
			break;
		...
		case 0o150: // BCHG D1,Dn
			this.rwop32(op, this.bchg32, this.d1);
			break;
		case 0o151: // MOVEP.L d(Ay),D1
			this.d1 = this.movep(op);
			break;
		...
		case 0o156: // BCHG D1,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d1);
			break;
		...
		case 0o160: // BCLR D1,Dn
			this.rwop32(op, this.bclr32, this.d1);
			break;
		case 0o161: // MOVEP.W D1,d(Ay)
			this.movep(op, this.d1);
			break;
		...
		case 0o166: // BCLR D1,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d1);
			break;
		...
		case 0o170: // BSET D1,Dn
			this.rwop32(op, this.bset32, this.d1);
			break;
		...
		case 0o176: // BSET D1,d(An,Xi)
			this.rwop8(op, this.bset8, this.d1);
			break;
		...
		case 0o206: // SUBI.B #<data>,d(An,Xi)
			this.rwop8(op, this.sub8, this.fetch16());
			break;
		...
		case 0o216: // SUBI.W #<data>,d(An,Xi)
			this.rwop16(op, this.sub16, this.fetch16());
			break;
		...
		case 0o226: // SUBI.L #<data>,d(An,Xi)
			this.rwop32(op, this.sub32, this.fetch32());
			break;
		...
		case 0o241: // MOVEP.W d(Ay),D2
			this.d2 = this.d2 & ~0xffff | this.movep(op);
			break;
		...
		case 0o246: // BTST D2,d(An,Xi)
			this.btst8(this.d2, this.rop8(op));
			break;
		...
		case 0o250: // BCHG D2,Dn
			this.rwop32(op, this.bchg32, this.d2);
			break;
		case 0o251: // MOVEP.L d(Ay),D2
			this.d2 = this.movep(op);
			break;
		...
		case 0o256: // BCHG D2,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d2);
			break;
		...
		case 0o260: // BCLR D2,Dn
			this.rwop32(op, this.bclr32, this.d2);
			break;
		case 0o261: // MOVEP.W D2,d(Ay)
			this.movep(op, this.d2);
			break;
		...
		case 0o266: // BCLR D2,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d2);
			break;
		...
		case 0o270: // BSET D2,Dn
			this.rwop32(op, this.bset32, this.d2);
			break;
		...
		case 0o276: // BSET D2,d(An,Xi)
			this.rwop8(op, this.bset8, this.d2);
			break;
		...
		case 0o306: // ADDI.B #<data>,d(An,Xi)
			this.rwop8(op, this.add8, this.fetch16());
			break;
		...
		case 0o316: // ADDI.W #<data>,d(An,Xi)
			this.rwop16(op, this.add16, this.fetch16());
			break;
		...
		case 0o346: // BTST D3,d(An,Xi)
			this.btst8(this.d3, this.rop8(op));
			break;
		...
		case 0o350: // BCHG D3,Dn
			this.rwop32(op, this.bchg32, this.d3);
			break;
		case 0o351: // MOVEP.L d(Ay),D3
			this.d3 = this.movep(op);
			break;
		...
		case 0o356: // BCHG D3,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d3);
			break;
		...
		case 0o360: // BCLR D3,Dn
			this.rwop32(op, this.bclr32, this.d3);
			break;
		case 0o361: // MOVEP.W D3,d(Ay)
			this.movep(op, this.d3);
			break;
		...
		case 0o366: // BCLR D3,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d3);
			break;
		...
		case 0o370: // BSET D3,Dn
			this.rwop32(op, this.bset32, this.d3);
			break;
		...
		case 0o376: // BSET D3,d(An,Xi)
			this.rwop8(op, this.bset8, this.d3);
			break;
		...
		case 0o400: // BTST #<data>,Dn
			this.btst32(this.fetch16(), this.rop32(op));
			break;
		...
		case 0o406: // BTST #<data>,d(An,Xi)
			this.btst8(this.fetch16(), this.rop8(op));
			break;
		...
		case 0o410: // BCHG #<data>,Dn
			this.rwop32(op, this.bchg32, this.fetch16());
			break;
		...
		case 0o416: // BCHG #<data>,d(An,Xi)
			this.rwop8(op, this.bchg8, this.fetch16());
			break;
		...
		case 0o420: // BCLR #<data>,Dn
			this.rwop32(op, this.bclr32, this.fetch16());
			break;
		...
		case 0o426: // BCLR #<data>,d(An,Xi)
			this.rwop8(op, this.bclr8, this.fetch16());
			break;
		...
		case 0o430: // BSET #<data>,Dn
			this.rwop32(op, this.bset32, this.fetch16());
			break;
		...
		case 0o436: // BSET #<data>,d(An,Xi)
			this.rwop8(op, this.bset8, this.fetch16());
			break;
		...
		case 0o440: // BTST D4,Dn
			this.btst32(this.d4, this.rop32(op));
			break;
		case 0o441: // MOVEP.W d(Ay),D4
			this.d4 = this.d4 & ~0xffff | this.movep(op);
			break;
		...
		case 0o446: // BTST D4,d(An,Xi)
			this.btst8(this.d4, this.rop8(op));
			break;
		...
		case 0o450: // BCHG D4,Dn
			this.rwop32(op, this.bchg32, this.d4);
			break;
		case 0o451: // MOVEP.L d(Ay),D4
			this.d4 = this.movep(op);
			break;
		...
		case 0o456: // BCHG D4,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d4);
			break;
		...
		case 0o460: // BCLR D4,Dn
			this.rwop32(op, this.bclr32, this.d4);
			break;
		case 0o461: // MOVEP.W D4,d(Ay)
			this.movep(op, this.d4);
			break;
		...
		case 0o466: // BCLR D4,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d4);
			break;
		...
		case 0o470: // BSET D4,Dn
			this.rwop32(op, this.bset32, this.d4);
			break;
		...
		case 0o476: // BSET D4,d(An,Xi)
			this.rwop8(op, this.bset8, this.d4);
			break;
		...
		case 0o526: // EORI.L #<data>,d(An,Xi)
			this.rwop32(op, this.eor32, this.fetch32());
			break;
		...
		case 0o540: // BTST D5,Dn
			this.btst32(this.d5, this.rop32(op));
			break;
		case 0o541: // MOVEP.W d(Ay),D5
			this.d5 = this.d5 & ~0xffff | this.movep(op);
			break;
		...
		case 0o546: // BTST D5,d(An,Xi)
			this.btst8(this.d5, this.rop8(op));
			break;
		...
		case 0o550: // BCHG D5,Dn
			this.rwop32(op, this.bchg32, this.d5);
			break;
		case 0o551: // MOVEP.L d(Ay),D5
			this.d5 = this.movep(op);
			break;
		...
		case 0o556: // BCHG D5,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d5);
			break;
		...
		case 0o560: // BCLR D5,Dn
			this.rwop32(op, this.bclr32, this.d5);
			break;
		case 0o561: // MOVEP.W D5,d(Ay)
			this.movep(op, this.d5);
			break;
		...
		case 0o566: // BCLR D5,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d5);
			break;
		...
		case 0o570: // BSET D5,Dn
			this.rwop32(op, this.bset32, this.d5);
			break;
		...
		case 0o576: // BSET D5,d(An,Xi)
			this.rwop8(op, this.bset8, this.d5);
			break;
		...
		case 0o606: // CMPI.B #<data>,d(An,Xi)
			this.cmp8(this.fetch16(), this.rop8(op));
			break;
		...
		case 0o616: // CMPI.W #<data>,d(An,Xi)
			this.cmp16(this.fetch16(), this.rop16(op));
			break;
		...
		case 0o626: // CMPI.L #<data>,d(An,Xi)
			this.cmp32(this.fetch32(), this.rop32(op));
			break;
		...
		case 0o640: // BTST D6,Dn
			this.btst32(this.d6, this.rop32(op));
			break;
		case 0o641: // MOVEP.W d(Ay),D6
			this.d6 = this.d6 & ~0xffff | this.movep(op);
			break;
		...
		case 0o646: // BTST D6,d(An,Xi)
			this.btst8(this.d6, this.rop8(op));
			break;
		...
		case 0o650: // BCHG D6,Dn
			this.rwop32(op, this.bchg32, this.d6);
			break;
		case 0o651: // MOVEP.L d(Ay),D6
			this.d6 = this.movep(op);
			break;
		...
		case 0o656: // BCHG D6,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d6);
			break;
		...
		case 0o660: // BCLR D6,Dn
			this.rwop32(op, this.bclr32, this.d6);
			break;
		case 0o661: // MOVEP.W D6,d(Ay)
			this.movep(op, this.d6);
			break;
		...
		case 0o666: // BCLR D6,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d6);
			break;
		...
		case 0o670: // BSET D6,Dn
			this.rwop32(op, this.bset32, this.d6);
			break;
		...
		case 0o676: // BSET D6,d(An,Xi)
			this.rwop8(op, this.bset8, this.d6);
			break;
		...
		case 0o740: // BTST D7,Dn
			this.btst32(this.d7, this.rop32(op));
			break;
		case 0o741: // MOVEP.W d(Ay),D7
			this.d7 = this.d7 & ~0xffff | this.movep(op);
			break;
		...
		case 0o746: // BTST D7,d(An,Xi)
			this.btst8(this.d7, this.rop8(op));
			break;
		...
		case 0o750: // BCHG D7,Dn
			this.rwop32(op, this.bchg32, this.d7);
			break;
		case 0o751: // MOVEP.L d(Ay),D7
			this.d7 = this.movep(op);
			break;
		...
		case 0o756: // BCHG D7,d(An,Xi)
			this.rwop8(op, this.bchg8, this.d7);
			break;
		...
		case 0o760: // BCLR D7,Dn
			this.rwop32(op, this.bclr32, this.d7);
			break;
		case 0o761: // MOVEP.W D7,d(Ay)
			this.movep(op, this.d7);
			break;
		...
		case 0o766: // BCLR D7,d(An,Xi)
			this.rwop8(op, this.bclr8, this.d7);
			break;
		...
		case 0o770: // BSET D7,Dn
			this.rwop32(op, this.bset32, this.d7);
			break;
		...
		case 0o776: // BSET D7,d(An,Xi)
			this.rwop8(op, this.bset8, this.d7);
			break;
	...
	execute_3(op) {
		...
		case 0o016: // MOVEA.W d(An,Xi),A0
			this.a0 = (this.a0 = this.rop16(op)) - (this.a0 << 1 & 0x10000);
			break;
		...
		case 0o116: // MOVEA.W d(An,Xi),A1
			this.a1 = (this.a1 = this.rop16(op)) - (this.a1 << 1 & 0x10000);
			break;
		...
		case 0o216: // MOVEA.W d(An,Xi),A2
			this.a2 = (this.a2 = this.rop16(op)) - (this.a2 << 1 & 0x10000);
			break;
		...
		case 0o316: // MOVEA.W d(An,Xi),A3
			this.a3 = (this.a3 = this.rop16(op)) - (this.a3 << 1 & 0x10000);
			break;
		...
		case 0o416: // MOVEA.W d(An,Xi),A4
			this.a4 = (this.a4 = this.rop16(op)) - (this.a4 << 1 & 0x10000);
			break;
		...
		case 0o516: // MOVEA.W d(An,Xi),A5
			this.a5 = (this.a5 = this.rop16(op)) - (this.a5 << 1 & 0x10000);
			break;
		...
		case 0o616: // MOVEA.W d(An,Xi),A6
			this.a6 = (this.a6 = this.rop16(op)) - (this.a6 << 1 & 0x10000);
			break;
		...
		case 0o716: // MOVEA.W d(An,Xi),A7
			this.a7 = (this.a7 = this.rop16(op)) - (this.a7 << 1 & 0x10000);
			break;
	...
	execute_4(op) {
		...
		case 0o036: // MOVE SR,d(An,Xi)
			this.rwop16(op, src => src, this.sr);
			break;
		...
		case 0o066: // CHK d(An,Xi),D0
			this.chk(this.rop16(op), this.d0);
			break;
		...
		case 0o166: // CHK d(An,Xi),D1
			this.chk(this.rop16(op), this.d1);
			break;
		...
		case 0o236: // MOVE d(An,Xi),CCR
			this.sr = this.sr & ~0xff | this.rop16(op) & 0xff;
			break;
		...
		case 0o266: // CHK d(An,Xi),D2
			this.chk(this.rop16(op), this.d2);
			break;
		...
		case 0o366: // CHK d(An,Xi),D3
			this.chk(this.rop16(op), this.d3);
			break;
		...
		case 0o407: // NBCD Abs...
			...
			break;
		case 0o410: // SWAP Dn
			this.rwop32(op, this.swap);
			break;
		case 0o412: // PEA (An)
		case 0o415: // PEA d(An)
		case 0o416: // PEA d(An,Xi)
			this.write32(this.lea(op), this.a7 = this.a7 - 4 | 0);
			break;
		case 0o417: // PEA Abs...
			if ((op & 7) >= 4)
				return void this.exception(4);
		...
		case 0o466: // CHK d(An,Xi),D4
			this.chk(this.rop16(op), this.d4);
			break;
		...
		case 0o566: // CHK d(An,Xi),D5
			this.chk(this.rop16(op), this.d5);
			break;
		...
		case 0o666: // CHK d(An,Xi),D6
			this.chk(this.rop16(op), this.d6);
			break;
		...
		case 0o712: // LINK An,#<displacement>
			this.rwop32(op & 7 | 0o10, this.link);
			break;
		case 0o713: // UNLK An
		...
		case 0o766: // CHK d(An,Xi),D7
			this.chk(this.rop16(op), this.d7);
			break;
	...
	execute_6(op) {
		...
		case 0xd: // BLT <label>
			...
			return;
		case 0xe: // BGT <label>
			if (((this.sr >>> 2 ^ this.sr | this.sr >>> 1) & 2) === 0)
				this.pc = base + disp | 0;
			return;
		case 0xf: // BLE <label>
			if (((this.sr >>> 2 ^ this.sr | this.sr >>> 1) & 2) !== 0)
	...
	execute_8(op) {
		...
		case 0o006: // OR.B d(An,Xi),D0
			this.d0 = this.d0 & ~0xff | this.or8(this.rop8(op), this.d0);
			break;
		...
		case 0o016: // OR.W d(An,Xi),D0
			this.d0 = this.d0 & ~0xffff | this.or16(this.rop16(op), this.d0);
			break;
		...
		case 0o026: // OR.L d(An,Xi),D0
			this.d0 = this.or32(this.rop32(op), this.d0);
			break;
		...
		case 0o036: // DIVU d(An,Xi),D0
			this.d0 = this.divu(this.rop16(op), this.d0);
			break;
		...
		case 0o040: // SBCD Dy,D0
			this.d0 = this.d0 & ~0xff | this.sbcd(this.rop8(op), this.d0);
			break;
		case 0o041: // SBCD -(Ay),-(A0)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a0 = this.a0 - 1 | 0)), this.a0);
			break;
		...
		case 0o046: // OR.B D0,d(An,Xi)
			this.rwop8(op, this.or8, this.d0);
			break;
		...
		case 0o056: // OR.W D0,d(An,Xi)
			this.rwop16(op, this.or16, this.d0);
			break;
		...
		case 0o066: // OR.L D0,d(An,Xi)
			this.rwop32(op, this.or32, this.d0);
			break;
		...
		case 0o076: // DIVS d(An,Xi),D0
			this.d0 = this.divs(this.rop16(op), this.d0);
			break;
		...
		case 0o106: // OR.B d(An,Xi),D1
			this.d1 = this.d1 & ~0xff | this.or8(this.rop8(op), this.d1);
			break;
		...
		case 0o116: // OR.W d(An,Xi),D1
			this.d1 = this.d1 & ~0xffff | this.or16(this.rop16(op), this.d1);
			break;
		...
		case 0o126: // OR.L d(An,Xi),D1
			this.d1 = this.or32(this.rop32(op), this.d1);
			break;
		...
		case 0o136: // DIVU d(An,Xi),D1
			this.d1 = this.divu(this.rop16(op), this.d1);
			break;
		...
		case 0o140: // SBCD Dy,D1
			this.d1 = this.d1 & ~0xff | this.sbcd(this.rop8(op), this.d1);
			break;
		case 0o141: // SBCD -(Ay),-(A1)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a1 = this.a1 - 1 | 0)), this.a1);
			break;
		...
		case 0o146: // OR.B D1,d(An,Xi)
			this.rwop8(op, this.or8, this.d1);
			break;
		...
		case 0o156: // OR.W D1,d(An,Xi)
			this.rwop16(op, this.or16, this.d1);
			break;
		...
		case 0o166: // OR.L D1,d(An,Xi)
			this.rwop32(op, this.or32, this.d1);
			break;
		...
		case 0o176: // DIVS d(An,Xi),D1
			this.d1 = this.divs(this.rop16(op), this.d1);
			break;
		...
		case 0o206: // OR.B d(An,Xi),D2
			this.d2 = this.d2 & ~0xff | this.or8(this.rop8(op), this.d2);
			break;
		...
		case 0o216: // OR.W d(An,Xi),D2
			this.d2 = this.d2 & ~0xffff | this.or16(this.rop16(op), this.d2);
			break;
		...
		case 0o226: // OR.L d(An,Xi),D2
			this.d2 = this.or32(this.rop32(op), this.d2);
			break;
		...
		case 0o236: // DIVU d(An,Xi),D2
			this.d2 = this.divu(this.rop16(op), this.d2);
			break;
		...
		case 0o240: // SBCD Dy,D2
			this.d2 = this.d2 & ~0xff | this.sbcd(this.rop8(op), this.d2);
			break;
		case 0o241: // SBCD -(Ay),-(A2)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a2 = this.a2 - 1 | 0)), this.a2);
			break;
		...
		case 0o246: // OR.B D2,d(An,Xi)
			this.rwop8(op, this.or8, this.d2);
			break;
		...
		case 0o256: // OR.W D2,d(An,Xi)
			this.rwop16(op, this.or16, this.d2);
			break;
		...
		case 0o266: // OR.L D2,d(An,Xi)
			this.rwop32(op, this.or32, this.d2);
			break;
		...
		case 0o276: // DIVS d(An,Xi),D2
			this.d2 = this.divs(this.rop16(op), this.d2);
			break;
		...
		case 0o306: // OR.B d(An,Xi),D3
			this.d3 = this.d3 & ~0xff | this.or8(this.rop8(op), this.d3);
			break;
		...
		case 0o316: // OR.W d(An,Xi),D3
			this.d3 = this.d3 & ~0xffff | this.or16(this.rop16(op), this.d3);
			break;
		...
		case 0o326: // OR.L d(An,Xi),D3
			this.d3 = this.or32(this.rop32(op), this.d3);
			break;
		...
		case 0o336: // DIVU d(An,Xi),D3
			this.d3 = this.divu(this.rop16(op), this.d3);
			break;
		...
		case 0o340: // SBCD Dy,D3
			this.d3 = this.d3 & ~0xff | this.sbcd(this.rop8(op), this.d3);
			break;
		case 0o341: // SBCD -(Ay),-(A3)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a3 = this.a3 - 1 | 0)), this.a3);
			break;
		...
		case 0o346: // OR.B D3,d(An,Xi)
			this.rwop8(op, this.or8, this.d3);
			break;
		...
		case 0o356: // OR.W D3,d(An,Xi)
			this.rwop16(op, this.or16, this.d3);
			break;
		...
		case 0o366: // OR.L D3,d(An,Xi)
			this.rwop32(op, this.or32, this.d3);
			break;
		...
		case 0o376: // DIVS d(An,Xi),D3
			this.d3 = this.divs(this.rop16(op), this.d3);
			break;
		...
		case 0o406: // OR.B d(An,Xi),D4
			this.d4 = this.d4 & ~0xff | this.or8(this.rop8(op), this.d4);
			break;
		...
		case 0o416: // OR.W d(An,Xi),D4
			this.d4 = this.d4 & ~0xffff | this.or16(this.rop16(op), this.d4);
			break;
		...
		case 0o426: // OR.L d(An,Xi),D4
			this.d4 = this.or32(this.rop32(op), this.d4);
			break;
		...
		case 0o436: // DIVU d(An,Xi),D4
			this.d4 = this.divu(this.rop16(op), this.d4);
			break;
		...
		case 0o440: // SBCD Dy,D4
			this.d4 = this.d4 & ~0xff | this.sbcd(this.rop8(op), this.d4);
			break;
		case 0o441: // SBCD -(Ay),-(A4)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a4 = this.a4 - 1 | 0)), this.a4);
			break;
		...
		case 0o446: // OR.B D4,d(An,Xi)
			this.rwop8(op, this.or8, this.d4);
			break;
		...
		case 0o456: // OR.W D4,d(An,Xi)
			this.rwop16(op, this.or16, this.d4);
			break;
		...
		case 0o466: // OR.L D4,d(An,Xi)
			this.rwop32(op, this.or32, this.d4);
			break;
		...
		case 0o476: // DIVS d(An,Xi),D4
			this.d4 = this.divs(this.rop16(op), this.d4);
			break;
		...
		case 0o506: // OR.B d(An,Xi),D5
			this.d5 = this.d5 & ~0xff | this.or8(this.rop8(op), this.d5);
			break;
		...
		case 0o516: // OR.W d(An,Xi),D5
			this.d5 = this.d5 & ~0xffff | this.or16(this.rop16(op), this.d5);
			break;
		...
		case 0o526: // OR.L d(An,Xi),D5
			this.d5 = this.or32(this.rop32(op), this.d5);
			break;
		...
		case 0o536: // DIVU d(An,Xi),D5
			this.d5 = this.divu(this.rop16(op), this.d5);
			break;
		...
		case 0o540: // SBCD Dy,D5
			this.d5 = this.d5 & ~0xff | this.sbcd(this.rop8(op), this.d5);
			break;
		case 0o541: // SBCD -(Ay),-(A5)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a5 = this.a5 - 1 | 0)), this.a5);
			break;
		...
		case 0o546: // OR.B D5,d(An,Xi)
			this.rwop8(op, this.or8, this.d5);
			break;
		...
		case 0o556: // OR.W D5,d(An,Xi)
			this.rwop16(op, this.or16, this.d5);
			break;
		...
		case 0o566: // OR.L D5,d(An,Xi)
			this.rwop32(op, this.or32, this.d5);
			break;
		...
		case 0o576: // DIVS d(An,Xi),D5
			this.d5 = this.divs(this.rop16(op), this.d5);
			break;
		...
		case 0o606: // OR.B d(An,Xi),D6
			this.d6 = this.d6 & ~0xff | this.or8(this.rop8(op), this.d6);
			break;
		...
		case 0o616: // OR.W d(An,Xi),D6
			this.d6 = this.d6 & ~0xffff | this.or16(this.rop16(op), this.d6);
			break;
		...
		case 0o626: // OR.L d(An,Xi),D6
			this.d6 = this.or32(this.rop32(op), this.d6);
			break;
		...
		case 0o636: // DIVU d(An,Xi),D6
			this.d6 = this.divu(this.rop16(op), this.d6);
			break;
		...
		case 0o640: // SBCD Dy,D6
			this.d6 = this.d6 & ~0xff | this.sbcd(this.rop8(op), this.d6);
			break;
		case 0o641: // SBCD -(Ay),-(A6)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a6 = this.a6 - 1 | 0)), this.a6);
			break;
		...
		case 0o646: // OR.B D6,d(An,Xi)
			this.rwop8(op, this.or8, this.d6);
			break;
		...
		case 0o656: // OR.W D6,d(An,Xi)
			this.rwop16(op, this.or16, this.d6);
			break;
		...
		case 0o666: // OR.L D6,d(An,Xi)
			this.rwop32(op, this.or32, this.d6);
			break;
		...
		case 0o676: // DIVS d(An,Xi),D6
			this.d6 = this.divs(this.rop16(op), this.d6);
			break;
		...
		case 0o706: // OR.B d(An,Xi),D7
			this.d7 = this.d7 & ~0xff | this.or8(this.rop8(op), this.d7);
			break;
		...
		case 0o716: // OR.W d(An,Xi),D7
			this.d7 = this.d7 & ~0xffff | this.or16(this.rop16(op), this.d7);
			break;
		...
		case 0o726: // OR.L d(An,Xi),D7
			this.d7 = this.or32(this.rop32(op), this.d7);
			break;
		...
		case 0o736: // DIVU d(An,Xi),D7
			this.d7 = this.divu(this.rop16(op), this.d7);
			break;
		...
		case 0o740: // SBCD Dy,D7
			this.d7 = this.d7 & ~0xff | this.sbcd(this.rop8(op), this.d7);
			break;
		case 0o741: // SBCD -(Ay),-(A7)
			this.write8(this.sbcd(this.rop8(op & 7 | 0o40), this.read8(this.a7 = this.a7 - 1 | 0)), this.a7);
			break;
		...
		case 0o746: // OR.B D7,d(An,Xi)
			this.rwop8(op, this.or8, this.d7);
			break;
		...
		case 0o756: // OR.W D7,d(An,Xi)
			this.rwop16(op, this.or16, this.d7);
			break;
		...
		case 0o766: // OR.L D7,d(An,Xi)
			this.rwop32(op, this.or32, this.d7);
			break;
		...
		case 0o776: // DIVS d(An,Xi),D7
			this.d7 = this.divs(this.rop16(op), this.d7);
			break;
	...
	execute_9(op) {
		...
		case 0o006: // SUB.B d(An,Xi),D0
			this.d0 = this.d0 & ~0xff | this.sub8(this.rop8(op), this.d0);
			break;
		...
		case 0o016: // SUB.W d(An,Xi),D0
			this.d0 = this.d0 & ~0xffff | this.sub16(this.rop16(op), this.d0);
			break;
		...
		case 0o026: // SUB.L d(An,Xi),D0
			this.d0 = this.sub32(this.rop32(op), this.d0);
			break;
		...
		case 0o036: // SUBA.W d(An,Xi),A0
			this.a0 = this.a0 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o040: // SUBX.B Dy,D0
			this.d0 = this.d0 & ~0xff | this.subx8(this.rop8(op), this.d0);
			break;
		case 0o041: // SUBX.B -(Ay),-(A0)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a0 = this.a0 - 1 | 0)), this.a0);
			break;
		...
		case 0o046: // SUB.B D0,d(An,Xi)
			this.rwop8(op, this.sub8, this.d0);
			break;
		...
		case 0o050: // SUBX.W Dy,D0
			this.d0 = this.d0 & ~0xffff | this.subx16(this.rop16(op), this.d0);
			break;
		case 0o051: // SUBX.W -(Ay),-(A0)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a0 = this.a0 - 2 | 0)), this.a0);
			break;
		...
		case 0o056: // SUB.W D0,d(An,Xi)
			this.rwop16(op, this.sub16, this.d0);
			break;
		...
		case 0o060: // SUBX.L Dy,D0
			this.d0 = this.subx32(this.rop32(op), this.d0);
			break;
		case 0o061: // SUBX.L -(Ay),-(A0)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a0 = this.a0 - 4 | 0)), this.a0);
			break;
		...
		case 0o066: // SUB.L D0,d(An,Xi)
			this.rwop32(op, this.sub32, this.d0);
			break;
		...
		case 0o076: // SUBA.L d(An,Xi),A0
			this.a0 = this.a0 - this.rop32(op) | 0;
			break;
		...
		case 0o106: // SUB.B d(An,Xi),D1
			this.d1 = this.d1 & ~0xff | this.sub8(this.rop8(op), this.d1);
			break;
		...
		case 0o116: // SUB.W d(An,Xi),D1
			this.d1 = this.d1 & ~0xffff | this.sub16(this.rop16(op), this.d1);
			break;
		...
		case 0o126: // SUB.L d(An,Xi),D1
			this.d1 = this.sub32(this.rop32(op), this.d1);
			break;
		...
		case 0o136: // SUBA.W d(An,Xi),A1
			this.a1 = this.a1 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o140: // SUBX.B Dy,D1
			this.d1 = this.d1 & ~0xff | this.subx8(this.rop8(op), this.d1);
			break;
		case 0o141: // SUBX.B -(Ay),-(A1)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a1 = this.a1 - 1 | 0)), this.a1);
			break;
		...
		case 0o146: // SUB.B D1,d(An,Xi)
			this.rwop8(op, this.sub8, this.d1);
			break;
		...
		case 0o150: // SUBX.W Dy,D1
			this.d1 = this.d1 & ~0xffff | this.subx16(this.rop16(op), this.d1);
			break;
		case 0o151: // SUBX.W -(Ay),-(A1)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a1 = this.a1 - 2 | 0)), this.a1);
			break;
		...
		case 0o156: // SUB.W D1,d(An,Xi)
			this.rwop16(op, this.sub16, this.d1);
			break;
		...
		case 0o160: // SUBX.L Dy,D1
			this.d1 = this.subx32(this.rop32(op), this.d1);
			break;
		case 0o161: // SUBX.L -(Ay),-(A1)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a1 = this.a1 - 4 | 0)), this.a1);
			break;
		...
		case 0o166: // SUB.L D1,d(An,Xi)
			this.rwop32(op, this.sub32, this.d1);
			break;
		...
		case 0o176: // SUBA.L d(An,Xi),A1
			this.a1 = this.a1 - this.rop32(op) | 0;
			break;
		...
		case 0o206: // SUB.B d(An,Xi),D2
			this.d2 = this.d2 & ~0xff | this.sub8(this.rop8(op), this.d2);
			break;
		...
		case 0o216: // SUB.W d(An,Xi),D2
			this.d2 = this.d2 & ~0xffff | this.sub16(this.rop16(op), this.d2);
			break;
		...
		case 0o226: // SUB.L d(An,Xi),D2
			this.d2 = this.sub32(this.rop32(op), this.d2);
			break;
		...
		case 0o236: // SUBA.W d(An,Xi),A2
			this.a2 = this.a2 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o240: // SUBX.B Dy,D2
			this.d2 = this.d2 & ~0xff | this.subx8(this.rop8(op), this.d2);
			break;
		case 0o241: // SUBX.B -(Ay),-(A2)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a2 = this.a2 - 1 | 0)), this.a2);
			break;
		...
		case 0o246: // SUB.B D2,d(An,Xi)
			this.rwop8(op, this.sub8, this.d2);
			break;
		...
		case 0o250: // SUBX.W Dy,D2
			this.d2 = this.d2 & ~0xffff | this.subx16(this.rop16(op), this.d2);
			break;
		case 0o251: // SUBX.W -(Ay),-(A2)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a2 = this.a2 - 2 | 0)), this.a2);
			break;
		...
		case 0o256: // SUB.W D2,d(An,Xi)
			this.rwop16(op, this.sub16, this.d2);
			break;
		...
		case 0o260: // SUBX.L Dy,D2
			this.d2 = this.subx32(this.rop32(op), this.d2);
			break;
		case 0o261: // SUBX.L -(Ay),-(A2)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a2 = this.a2 - 4 | 0)), this.a2);
			break;
		...
		case 0o266: // SUB.L D2,d(An,Xi)
			this.rwop32(op, this.sub32, this.d2);
			break;
		...
		case 0o276: // SUBA.L d(An,Xi),A2
			this.a2 = this.a2 - this.rop32(op) | 0;
			break;
		...
		case 0o306: // SUB.B d(An,Xi),D3
			this.d3 = this.d3 & ~0xff | this.sub8(this.rop8(op), this.d3);
			break;
		...
		case 0o316: // SUB.W d(An,Xi),D3
			this.d3 = this.d3 & ~0xffff | this.sub16(this.rop16(op), this.d3);
			break;
		...
		case 0o326: // SUB.L d(An,Xi),D3
			this.d3 = this.sub32(this.rop32(op), this.d3);
			break;
		...
		case 0o336: // SUBA.W d(An,Xi),A3
			this.a3 = this.a3 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o340: // SUBX.B Dy,D3
			this.d3 = this.d3 & ~0xff | this.subx8(this.rop8(op), this.d3);
			break;
		case 0o341: // SUBX.B -(Ay),-(A3)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a3 = this.a3 - 1 | 0)), this.a3);
			break;
		...
		case 0o346: // SUB.B D3,d(An,Xi)
			this.rwop8(op, this.sub8, this.d3);
			break;
		...
		case 0o350: // SUBX.W Dy,D3
			this.d3 = this.d3 & ~0xffff | this.subx16(this.rop16(op), this.d3);
			break;
		case 0o351: // SUBX.W -(Ay),-(A3)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a3 = this.a3 - 2 | 0)), this.a3);
			break;
		...
		case 0o356: // SUB.W D3,d(An,Xi)
			this.rwop16(op, this.sub16, this.d3);
			break;
		...
		case 0o360: // SUBX.L Dy,D3
			this.d3 = this.subx32(this.rop32(op), this.d3);
			break;
		case 0o361: // SUBX.L -(Ay),-(A3)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a3 = this.a3 - 4 | 0)), this.a3);
			break;
		...
		case 0o366: // SUB.L D3,d(An,Xi)
			this.rwop32(op, this.sub32, this.d3);
			break;
		...
		case 0o376: // SUBA.L d(An,Xi),A3
			this.a3 = this.a3 - this.rop32(op) | 0;
			break;
		...
		case 0o406: // SUB.B d(An,Xi),D4
			this.d4 = this.d4 & ~0xff | this.sub8(this.rop8(op), this.d4);
			break;
		...
		case 0o416: // SUB.W d(An,Xi),D4
			this.d4 = this.d4 & ~0xffff | this.sub16(this.rop16(op), this.d4);
			break;
		...
		case 0o426: // SUB.L d(An,Xi),D4
			this.d4 = this.sub32(this.rop32(op), this.d4);
			break;
		...
		case 0o436: // SUBA.W d(An,Xi),A4
			this.a4 = this.a4 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o440: // SUBX.B Dy,D4
			this.d4 = this.d4 & ~0xff | this.subx8(this.rop8(op), this.d4);
			break;
		case 0o441: // SUBX.B -(Ay),-(A4)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a4 = this.a4 - 1 | 0)), this.a4);
			break;
		...
		case 0o446: // SUB.B D4,d(An,Xi)
			this.rwop8(op, this.sub8, this.d4);
			break;
		...
		case 0o450: // SUBX.W Dy,D4
			this.d4 = this.d4 & ~0xffff | this.subx16(this.rop16(op), this.d4);
			break;
		case 0o451: // SUBX.W -(Ay),-(A4)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a4 = this.a4 - 2 | 0)), this.a4);
			break;
		...
		case 0o456: // SUB.W D4,d(An,Xi)
			this.rwop16(op, this.sub16, this.d4);
			break;
		...
		case 0o460: // SUBX.L Dy,D4
			this.d4 = this.subx32(this.rop32(op), this.d4);
			break;
		case 0o461: // SUBX.L -(Ay),-(A4)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a4 = this.a4 - 4 | 0)), this.a4);
			break;
		...
		case 0o466: // SUB.L D4,d(An,Xi)
			this.rwop32(op, this.sub32, this.d4);
			break;
		...
		case 0o476: // SUBA.L d(An,Xi),A4
			this.a4 = this.a4 - this.rop32(op) | 0;
			break;
		...
		case 0o506: // SUB.B d(An,Xi),D5
			this.d5 = this.d5 & ~0xff | this.sub8(this.rop8(op), this.d5);
			break;
		...
		case 0o516: // SUB.W d(An,Xi),D5
			this.d5 = this.d5 & ~0xffff | this.sub16(this.rop16(op), this.d5);
			break;
		...
		case 0o526: // SUB.L d(An,Xi),D5
			this.d5 = this.sub32(this.rop32(op), this.d5);
			break;
		...
		case 0o536: // SUBA.W d(An,Xi),A5
			this.a5 = this.a5 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o540: // SUBX.B Dy,D5
			this.d5 = this.d5 & ~0xff | this.subx8(this.rop8(op), this.d5);
			break;
		case 0o541: // SUBX.B -(Ay),-(A5)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a5 = this.a5 - 1 | 0)), this.a5);
			break;
		...
		case 0o546: // SUB.B D5,d(An,Xi)
			this.rwop8(op, this.sub8, this.d5);
			break;
		...
		case 0o550: // SUBX.W Dy,D5
			this.d5 = this.d5 & ~0xffff | this.subx16(this.rop16(op), this.d5);
			break;
		case 0o551: // SUBX.W -(Ay),-(A5)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a5 = this.a5 - 2 | 0)), this.a5);
			break;
		...
		case 0o556: // SUB.W D5,d(An,Xi)
			this.rwop16(op, this.sub16, this.d5);
			break;
		...
		case 0o560: // SUBX.L Dy,D5
			this.d5 = this.subx32(this.rop32(op), this.d5);
			break;
		case 0o561: // SUBX.L -(Ay),-(A5)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a5 = this.a5 - 4 | 0)), this.a5);
			break;
		...
		case 0o566: // SUB.L D5,d(An,Xi)
			this.rwop32(op, this.sub32, this.d5);
			break;
		...
		case 0o576: // SUBA.L d(An,Xi),A5
			this.a5 = this.a5 - this.rop32(op) | 0;
			break;
		...
		case 0o606: // SUB.B d(An,Xi),D6
			this.d6 = this.d6 & ~0xff | this.sub8(this.rop8(op), this.d6);
			break;
		...
		case 0o616: // SUB.W d(An,Xi),D6
			this.d6 = this.d6 & ~0xffff | this.sub16(this.rop16(op), this.d6);
			break;
		...
		case 0o626: // SUB.L d(An,Xi),D6
			this.d6 = this.sub32(this.rop32(op), this.d6);
			break;
		...
		case 0o636: // SUBA.W d(An,Xi),A6
			this.a6 = this.a6 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o640: // SUBX.B Dy,D6
			this.d6 = this.d6 & ~0xff | this.subx8(this.rop8(op), this.d6);
			break;
		case 0o641: // SUBX.B -(Ay),-(A6)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a6 = this.a6 - 1 | 0)), this.a6);
			break;
		...
		case 0o646: // SUB.B D6,d(An,Xi)
			this.rwop8(op, this.sub8, this.d6);
			break;
		...
		case 0o650: // SUBX.W Dy,D6
			this.d6 = this.d6 & ~0xffff | this.subx16(this.rop16(op), this.d6);
			break;
		case 0o651: // SUBX.W -(Ay),-(A6)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a6 = this.a6 - 2 | 0)), this.a6);
			break;
		...
		case 0o656: // SUB.W D6,d(An,Xi)
			this.rwop16(op, this.sub16, this.d6);
			break;
		...
		case 0o660: // SUBX.L Dy,D6
			this.d6 = this.subx32(this.rop32(op), this.d6);
			break;
		case 0o661: // SUBX.L -(Ay),-(A6)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a6 = this.a6 - 4 | 0)), this.a6);
			break;
		...
		case 0o666: // SUB.L D6,d(An,Xi)
			this.rwop32(op, this.sub32, this.d6);
			break;
		...
		case 0o676: // SUBA.L d(An,Xi),A6
			this.a6 = this.a6 - this.rop32(op) | 0;
			break;
		...
		case 0o706: // SUB.B d(An,Xi),D7
			this.d7 = this.d7 & ~0xff | this.sub8(this.rop8(op), this.d7);
			break;
		...
		case 0o716: // SUB.W d(An,Xi),D7
			this.d7 = this.d7 & ~0xffff | this.sub16(this.rop16(op), this.d7);
			break;
		...
		case 0o726: // SUB.L d(An,Xi),D7
			this.d7 = this.sub32(this.rop32(op), this.d7);
			break;
		...
		case 0o736: // SUBA.W d(An,Xi),A7
			this.a7 = this.a7 - (data = this.rop16(op)) + (data << 1 & 0x10000) | 0;
			break;
		...
		case 0o740: // SUBX.B Dy,D7
			this.d7 = this.d7 & ~0xff | this.subx8(this.rop8(op), this.d7);
			break;
		case 0o741: // SUBX.B -(Ay),-(A7)
			this.write8(this.subx8(this.rop8(op & 7 | 0o40), this.read8(this.a7 = this.a7 - 1 | 0)), this.a7);
			break;
		...
		case 0o746: // SUB.B D7,d(An,Xi)
			this.rwop8(op, this.sub8, this.d7);
			break;
		...
		case 0o750: // SUBX.W Dy,D7
			this.d7 = this.d7 & ~0xffff | this.subx16(this.rop16(op), this.d7);
			break;
		case 0o751: // SUBX.W -(Ay),-(A7)
			this.write16(this.subx16(this.rop16(op & 7 | 0o40), this.read16(this.a7 = this.a7 - 2 | 0)), this.a7);
			break;
		...
		case 0o756: // SUB.W D7,d(An,Xi)
			this.rwop16(op, this.sub16, this.d7);
			break;
		...
		case 0o760: // SUBX.L Dy,D7
			this.d7 = this.subx32(this.rop32(op), this.d7);
			break;
		case 0o761: // SUBX.L -(Ay),-(A7)
			this.write32(this.subx32(this.rop32(op & 7 | 0o40), this.read32(this.a7 = this.a7 - 4 | 0)), this.a7);
			break;
		...
		case 0o766: // SUB.L D7,d(An,Xi)
			this.rwop32(op, this.sub32, this.d7);
			break;
		...
		case 0o776: // SUBA.L d(An,Xi),A7
			this.a7 = this.a7 - this.rop32(op) | 0;
			break;
	...
	execute_b(op) {
		...
		case 0o006: // CMP.B d(An,Xi),D0
			this.cmp8(this.rop8(op), this.d0);
			break;
		...
		case 0o016: // CMP.W d(An,Xi),D0
			this.cmp16(this.rop16(op), this.d0);
			break;
		...
		case 0o026: // CMP.L d(An,Xi),D0
			this.cmp32(this.rop32(op), this.d0);
			break;
		...
		case 0o036: // CMPA.W d(An,Xi),A0
			this.cmpa16(this.rop16(op), this.a0);
			break;
		...
		case 0o040: // EOR.B D0,Dn
			this.rwop8(op, this.eor8, this.d0);
			break;
		...
		case 0o050: // EOR.W D0,Dn
			this.rwop16(op, this.eor16, this.d0);
			break;
		...
		case 0o060: // EOR.L D0,Dn
			this.rwop32(op, this.eor32, this.d0);
			break;
		...
		case 0o076: // CMPA.L d(An,Xi),A0
			this.cmpa32(this.rop32(op), this.a0);
			break;
		...
		case 0o106: // CMP.B d(An,Xi),D1
			this.cmp8(this.rop8(op), this.d1);
			break;
		...
		case 0o116: // CMP.W d(An,Xi),D1
			this.cmp16(this.rop16(op), this.d1);
			break;
		...
		case 0o126: // CMP.L d(An,Xi),D1
			this.cmp32(this.rop32(op), this.d1);
			break;
		...
		case 0o136: // CMPA.W d(An,Xi),A1
			this.cmpa16(this.rop16(op), this.a1);
			break;
		...
		case 0o140: // EOR.B D1,Dn
			this.rwop8(op, this.eor8, this.d1);
			break;
		...
		case 0o150: // EOR.W D1,Dn
			this.rwop16(op, this.eor16, this.d1);
			break;
		...
		case 0o160: // EOR.L D1,Dn
			this.rwop32(op, this.eor32, this.d1);
			break;
		...
		case 0o176: // CMPA.L d(An,Xi),A1
			this.cmpa32(this.rop32(op), this.a1);
			break;
		...
		case 0o206: // CMP.B d(An,Xi),D2
			this.cmp8(this.rop8(op), this.d2);
			break;
		...
		case 0o216: // CMP.W d(An,Xi),D2
			this.cmp16(this.rop16(op), this.d2);
			break;
		...
		case 0o226: // CMP.L d(An,Xi),D2
			this.cmp32(this.rop32(op), this.d2);
			break;
		...
		case 0o236: // CMPA.W d(An,Xi),A2
			this.cmpa16(this.rop16(op), this.a2);
			break;
		...
		case 0o240: // EOR.B D2,Dn
			this.rwop8(op, this.eor8, this.d2);
			break;
		...
		case 0o250: // EOR.W D2,Dn
			this.rwop16(op, this.eor16, this.d2);
			break;
		...
		case 0o260: // EOR.L D2,Dn
			this.rwop32(op, this.eor32, this.d2);
			break;
		...
		case 0o276: // CMPA.L d(An,Xi),A2
			this.cmpa32(this.rop32(op), this.a2);
			break;
		...
		case 0o306: // CMP.B d(An,Xi),D3
			this.cmp8(this.rop8(op), this.d3);
			break;
		...
		case 0o316: // CMP.W d(An,Xi),D3
			this.cmp16(this.rop16(op), this.d3);
			break;
		...
		case 0o326: // CMP.L d(An,Xi),D3
			this.cmp32(this.rop32(op), this.d3);
			break;
		...
		case 0o336: // CMPA.W d(An,Xi),A3
			this.cmpa16(this.rop16(op), this.a3);
			break;
		...
		case 0o340: // EOR.B D3,Dn
			this.rwop8(op, this.eor8, this.d3);
			break;
		...
		case 0o350: // EOR.W D3,Dn
			this.rwop16(op, this.eor16, this.d3);
			break;
		...
		case 0o360: // EOR.L D3,Dn
			this.rwop32(op, this.eor32, this.d3);
			break;
		...
		case 0o376: // CMPA.L d(An,Xi),A3
			this.cmpa32(this.rop32(op), this.a3);
			break;
		...
		case 0o406: // CMP.B d(An,Xi),D4
			this.cmp8(this.rop8(op), this.d4);
			break;
		...
		case 0o416: // CMP.W d(An,Xi),D4
			this.cmp16(this.rop16(op), this.d4);
			break;
		...
		case 0o426: // CMP.L d(An,Xi),D4
			this.cmp32(this.rop32(op), this.d4);
			break;
		...
		case 0o436: // CMPA.W d(An,Xi),A4
			this.cmpa16(this.rop16(op), this.a4);
			break;
		...
		case 0o440: // EOR.B D4,Dn
			this.rwop8(op, this.eor8, this.d4);
			break;
		...
		case 0o450: // EOR.W D4,Dn
			this.rwop16(op, this.eor16, this.d4);
			break;
		...
		case 0o460: // EOR.L D4,Dn
			this.rwop32(op, this.eor32, this.d4);
			break;
		...
		case 0o476: // CMPA.L d(An,Xi),A4
			this.cmpa32(this.rop32(op), this.a4);
			break;
		...
		case 0o506: // CMP.B d(An,Xi),D5
			this.cmp8(this.rop8(op), this.d5);
			break;
		...
		case 0o516: // CMP.W d(An,Xi),D5
			this.cmp16(this.rop16(op), this.d5);
			break;
		...
		case 0o526: // CMP.L d(An,Xi),D5
			this.cmp32(this.rop32(op), this.d5);
			break;
		...
		case 0o536: // CMPA.W d(An,Xi),A5
			this.cmpa16(this.rop16(op), this.a5);
			break;
		...
		case 0o540: // EOR.B D5,Dn
			this.rwop8(op, this.eor8, this.d5);
			break;
		...
		case 0o550: // EOR.W D5,Dn
			this.rwop16(op, this.eor16, this.d5);
			break;
		...
		case 0o560: // EOR.L D5,Dn
			this.rwop32(op, this.eor32, this.d5);
			break;
		...
		case 0o576: // CMPA.L d(An,Xi),A5
			this.cmpa32(this.rop32(op), this.a5);
			break;
		...
		case 0o606: // CMP.B d(An,Xi),D6
			this.cmp8(this.rop8(op), this.d6);
			break;
		...
		case 0o616: // CMP.W d(An,Xi),D6
			this.cmp16(this.rop16(op), this.d6);
			break;
		...
		case 0o626: // CMP.L d(An,Xi),D6
			this.cmp32(this.rop32(op), this.d6);
			break;
		...
		case 0o636: // CMPA.W d(An,Xi),A6
			this.cmpa16(this.rop16(op), this.a6);
			break;
		...
		case 0o640: // EOR.B D6,Dn
			this.rwop8(op, this.eor8, this.d6);
			break;
		...
		case 0o650: // EOR.W D6,Dn
			this.rwop16(op, this.eor16, this.d6);
			break;
		...
		case 0o660: // EOR.L D6,Dn
			this.rwop32(op, this.eor32, this.d6);
			break;
		...
		case 0o676: // CMPA.L d(An,Xi),A6
			this.cmpa32(this.rop32(op), this.a6);
			break;
		...
		case 0o706: // CMP.B d(An,Xi),D7
			this.cmp8(this.rop8(op), this.d7);
			break;
		...
		case 0o716: // CMP.W d(An,Xi),D7
			this.cmp16(this.rop16(op), this.d7);
			break;
		...
		case 0o726: // CMP.L d(An,Xi),D7
			this.cmp32(this.rop32(op), this.d7);
			break;
		...
		case 0o736: // CMPA.W d(An,Xi),A7
			this.cmpa16(this.rop16(op), this.a7);
			break;
		...
		case 0o740: // EOR.B D7,Dn
			this.rwop8(op, this.eor8, this.d7);
			break;
		...
		case 0o750: // EOR.W D7,Dn
			this.rwop16(op, this.eor16, this.d7);
			break;
		...
		case 0o760: // EOR.L D7,Dn
			this.rwop32(op, this.eor32, this.d7);
			break;
		...
		case 0o776: // CMPA.L d(An,Xi),A7
			this.cmpa32(this.rop32(op), this.a7);
			break;
	...
	execute_c(op) {
		...
		case 0o006: // AND.B d(An,Xi),D0
			this.d0 = this.d0 & ~0xff | this.and8(this.rop8(op), this.d0);
			break;
		...
		case 0o016: // AND.W d(An,Xi),D0
			this.d0 = this.d0 & ~0xffff | this.and16(this.rop16(op), this.d0);
			break;
		...
		case 0o026: // AND.L d(An,Xi),D0
			this.d0 = this.and32(this.rop32(op), this.d0);
			break;
		...
		case 0o036: // MULU d(An,Xi),D0
			this.d0 = this.mulu(this.rop16(op), this.d0 & 0xffff);
			break;
		...
		case 0o040: // ABCD Dy,D0
			this.d0 = this.d0 & ~0xff | this.abcd(this.rop8(op), this.d0);
			break;
		case 0o041: // ABCD -(Ay),-(A0)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a0 = this.a0 - 1 | 0)), this.a0);
			break;
		...
		case 0o046: // AND.B D0,d(An,Xi)
			this.rwop8(op, this.and8, this.d0);
			break;
		...
		case 0o050: // EXG D0,Dy
			this.d0 = this.exg(op, this.d0);
			break;
		case 0o051: // EXG A0,Ay
			this.a0 = this.exg(op, this.a0);
			break;
		...
		case 0o056: // AND.W D0,d(An,Xi)
			this.rwop16(op, this.and16, this.d0);
			break;
		...
		case 0o066: // AND.L D0,d(An,Xi)
			this.rwop32(op, this.and32, this.d0);
			break;
		...
		case 0o076: // MULS d(An,Xi),D0
			this.d0 = this.muls(this.rop16(op), this.d0 & 0xffff);
			break;
		...
		case 0o106: // AND.B d(An,Xi),D1
			this.d1 = this.d1 & ~0xff | this.and8(this.rop8(op), this.d1);
			break;
		...
		case 0o116: // AND.W d(An,Xi),D1
			this.d1 = this.d1 & ~0xffff | this.and16(this.rop16(op), this.d1);
			break;
		...
		case 0o126: // AND.L d(An,Xi),D1
			this.d1 = this.and32(this.rop32(op), this.d1);
			break;
		...
		case 0o136: // MULU d(An,Xi),D1
			this.d1 = this.mulu(this.rop16(op), this.d1 & 0xffff);
			break;
		...
		case 0o140: // ABCD Dy,D1
			this.d1 = this.d1 & ~0xff | this.abcd(this.rop8(op), this.d1);
			break;
		case 0o141: // ABCD -(Ay),-(A1)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a1 = this.a1 - 1 | 0)), this.a1);
			break;
		...
		case 0o146: // AND.B D1,d(An,Xi)
			this.rwop8(op, this.and8, this.d1);
			break;
		...
		case 0o150: // EXG D1,Dy
			this.d1 = this.exg(op, this.d1);
			break;
		case 0o151: // EXG A1,Ay
			this.a1 = this.exg(op, this.a1);
			break;
		...
		case 0o156: // AND.W D1,d(An,Xi)
			this.rwop16(op, this.and16, this.d1);
			break;
		...
		case 0o166: // AND.L D1,d(An,Xi)
			this.rwop32(op, this.and32, this.d1);
			break;
		...
		case 0o176: // MULS d(An,Xi),D1
			this.d1 = this.muls(this.rop16(op), this.d1 & 0xffff);
			break;
		...
		case 0o206: // AND.B d(An,Xi),D2
			this.d2 = this.d2 & ~0xff | this.and8(this.rop8(op), this.d2);
			break;
		...
		case 0o216: // AND.W d(An,Xi),D2
			this.d2 = this.d2 & ~0xffff | this.and16(this.rop16(op), this.d2);
			break;
		...
		case 0o226: // AND.L d(An,Xi),D2
			this.d2 = this.and32(this.rop32(op), this.d2);
			break;
		...
		case 0o236: // MULU d(An,Xi),D2
			this.d2 = this.mulu(this.rop16(op), this.d2 & 0xffff);
			break;
		...
		case 0o240: // ABCD Dy,D2
			this.d2 = this.d2 & ~0xff | this.abcd(this.rop8(op), this.d2);
			break;
		case 0o241: // ABCD -(Ay),-(A2)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a2 = this.a2 - 1 | 0)), this.a2);
			break;
		...
		case 0o246: // AND.B D2,d(An,Xi)
			this.rwop8(op, this.and8, this.d2);
			break;
		...
		case 0o250: // EXG D2,Dy
			this.d2 = this.exg(op, this.d2);
			break;
		case 0o251: // EXG A2,Ay
			this.a2 = this.exg(op, this.a2);
			break;
		...
		case 0o256: // AND.W D2,d(An,Xi)
			this.rwop16(op, this.and16, this.d2);
			break;
		...
		case 0o266: // AND.L D2,d(An,Xi)
			this.rwop32(op, this.and32, this.d2);
			break;
		...
		case 0o276: // MULS d(An,Xi),D2
			this.d2 = this.muls(this.rop16(op), this.d2 & 0xffff);
			break;
		...
		case 0o306: // AND.B d(An,Xi),D3
			this.d3 = this.d3 & ~0xff | this.and8(this.rop8(op), this.d3);
			break;
		...
		case 0o316: // AND.W d(An,Xi),D3
			this.d3 = this.d3 & ~0xffff | this.and16(this.rop16(op), this.d3);
			break;
		...
		case 0o326: // AND.L d(An,Xi),D3
			this.d3 = this.and32(this.rop32(op), this.d3);
			break;
		...
		case 0o336: // MULU d(An,Xi),D3
			this.d3 = this.mulu(this.rop16(op), this.d3 & 0xffff);
			break;
		...
		case 0o340: // ABCD Dy,D3
			this.d3 = this.d3 & ~0xff | this.abcd(this.rop8(op), this.d3);
			break;
		case 0o341: // ABCD -(Ay),-(A3)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a3 = this.a3 - 1 | 0)), this.a3);
			break;
		...
		case 0o346: // AND.B D3,d(An,Xi)
			this.rwop8(op, this.and8, this.d3);
			break;
		...
		case 0o350: // EXG D3,Dy
			this.d3 = this.exg(op, this.d3);
			break;
		case 0o351: // EXG A3,Ay
			this.a3 = this.exg(op, this.a3);
			break;
		...
		case 0o356: // AND.W D3,d(An,Xi)
			this.rwop16(op, this.and16, this.d3);
			break;
		...
		case 0o366: // AND.L D3,d(An,Xi)
			this.rwop32(op, this.and32, this.d3);
			break;
		...
		case 0o376: // MULS d(An,Xi),D3
			this.d3 = this.muls(this.rop16(op), this.d3 & 0xffff);
			break;
		...
		case 0o406: // AND.B d(An,Xi),D4
			this.d4 = this.d4 & ~0xff | this.and8(this.rop8(op), this.d4);
			break;
		...
		case 0o416: // AND.W d(An,Xi),D4
			this.d4 = this.d4 & ~0xffff | this.and16(this.rop16(op), this.d4);
			break;
		...
		case 0o426: // AND.L d(An,Xi),D4
			this.d4 = this.and32(this.rop32(op), this.d4);
			break;
		...
		case 0o436: // MULU d(An,Xi),D4
			this.d4 = this.mulu(this.rop16(op), this.d4 & 0xffff);
			break;
		...
		case 0o440: // ABCD Dy,D4
			this.d4 = this.d4 & ~0xff | this.abcd(this.rop8(op), this.d4);
			break;
		case 0o441: // ABCD -(Ay),-(A4)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a4 = this.a4 - 1 | 0)), this.a4);
			break;
		...
		case 0o446: // AND.B D4,d(An,Xi)
			this.rwop8(op, this.and8, this.d4);
			break;
		...
		case 0o450: // EXG D4,Dy
			this.d4 = this.exg(op, this.d4);
			break;
		case 0o451: // EXG A4,Ay
			this.a4 = this.exg(op, this.a4);
			break;
		...
		case 0o456: // AND.W D4,d(An,Xi)
			this.rwop16(op, this.and16, this.d4);
			break;
		...
		case 0o466: // AND.L D4,d(An,Xi)
			this.rwop32(op, this.and32, this.d4);
			break;
		...
		case 0o476: // MULS d(An,Xi),D4
			this.d4 = this.muls(this.rop16(op), this.d4 & 0xffff);
			break;
		...
		case 0o506: // AND.B d(An,Xi),D5
			this.d5 = this.d5 & ~0xff | this.and8(this.rop8(op), this.d5);
			break;
		...
		case 0o516: // AND.W d(An,Xi),D5
			this.d5 = this.d5 & ~0xffff | this.and16(this.rop16(op), this.d5);
			break;
		...
		case 0o526: // AND.L d(An,Xi),D5
			this.d5 = this.and32(this.rop32(op), this.d5);
			break;
		...
		case 0o536: // MULU d(An,Xi),D5
			this.d5 = this.mulu(this.rop16(op), this.d5 & 0xffff);
			break;
		...
		case 0o540: // ABCD Dy,D5
			this.d5 = this.d5 & ~0xff | this.abcd(this.rop8(op), this.d5);
			break;
		case 0o541: // ABCD -(Ay),-(A5)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a5 = this.a5 - 1 | 0)), this.a5);
			break;
		...
		case 0o546: // AND.B D5,d(An,Xi)
			this.rwop8(op, this.and8, this.d5);
			break;
		...
		case 0o550: // EXG D5,Dy
			this.d5 = this.exg(op, this.d5);
			break;
		case 0o551: // EXG A5,Ay
			this.a5 = this.exg(op, this.a5);
			break;
		...
		case 0o556: // AND.W D5,d(An,Xi)
			this.rwop16(op, this.and16, this.d5);
			break;
		...
		case 0o566: // AND.L D5,d(An,Xi)
			this.rwop32(op, this.and32, this.d5);
			break;
		...
		case 0o576: // MULS d(An,Xi),D5
			this.d5 = this.muls(this.rop16(op), this.d5 & 0xffff);
			break;
		...
		case 0o606: // AND.B d(An,Xi),D6
			this.d6 = this.d6 & ~0xff | this.and8(this.rop8(op), this.d6);
			break;
		...
		case 0o616: // AND.W d(An,Xi),D6
			this.d6 = this.d6 & ~0xffff | this.and16(this.rop16(op), this.d6);
			break;
		...
		case 0o626: // AND.L d(An,Xi),D6
			this.d6 = this.and32(this.rop32(op), this.d6);
			break;
		...
		case 0o636: // MULU d(An,Xi),D6
			this.d6 = this.mulu(this.rop16(op), this.d6 & 0xffff);
			break;
		...
		case 0o640: // ABCD Dy,D6
			this.d6 = this.d6 & ~0xff | this.abcd(this.rop8(op), this.d6);
			break;
		case 0o641: // ABCD -(Ay),-(A6)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a6 = this.a6 - 1 | 0)), this.a6);
			break;
		...
		case 0o646: // AND.B D6,d(An,Xi)
			this.rwop8(op, this.and8, this.d6);
			break;
		...
		case 0o650: // EXG D6,Dy
			this.d6 = this.exg(op, this.d6);
			break;
		case 0o651: // EXG A6,Ay
			this.a6 = this.exg(op, this.a6);
			break;
		...
		case 0o656: // AND.W D6,d(An,Xi)
			this.rwop16(op, this.and16, this.d6);
			break;
		...
		case 0o666: // AND.L D6,d(An,Xi)
			this.rwop32(op, this.and32, this.d6);
			break;
		...
		case 0o676: // MULS d(An,Xi),D6
			this.d6 = this.muls(this.rop16(op), this.d6 & 0xffff);
			break;
		...
		case 0o706: // AND.B d(An,Xi),D7
			this.d7 = this.d7 & ~0xff | this.and8(this.rop8(op), this.d7);
			break;
		...
		case 0o716: // AND.W d(An,Xi),D7
			this.d7 = this.d7 & ~0xffff | this.and16(this.rop16(op), this.d7);
			break;
		...
		case 0o726: // AND.L d(An,Xi),D7
			this.d7 = this.and32(this.rop32(op), this.d7);
			break;
		...
		case 0o736: // MULU d(An,Xi),D7
			this.d7 = this.mulu(this.rop16(op), this.d7 & 0xffff);
			break;
		...
		case 0o740: // ABCD Dy,D7
			this.d7 = this.d7 & ~0xff | this.abcd(this.rop8(op), this.d7);
			break;
		case 0o741: // ABCD -(Ay),-(A7)
			this.write8(this.abcd(this.rop8(op & 7 | 0o40), this.read8(this.a7 = this.a7 - 1 | 0)), this.a7);
			break;
		...
		case 0o746: // AND.B D7,d(An,Xi)
			this.rwop8(op, this.and8, this.d7);
			break;
		...
		case 0o750: // EXG D7,Dy
			this.d7 = this.exg(op, this.d7);
			break;
		case 0o751: // EXG A7,Ay
			this.a7 = this.exg(op, this.a7);
			break;
		...
		case 0o756: // AND.W D7,d(An,Xi)
			this.rwop16(op, this.and16, this.d7);
			break;
		...
		case 0o766: // AND.L D7,d(An,Xi)
			this.rwop32(op, this.and32, this.d7);
			break;
		...
		case 0o776: // MULS d(An,Xi),D7
			this.d7 = this.muls(this.rop16(op), this.d7 & 0xffff);
			break;
	...
	execute_d(op) {
		...
		case 0o006: // ADD.B d(An,Xi),D0
			this.d0 = this.d0 & ~0xff | this.add8(this.rop8(op), this.d0);
			break;
		...
		case 0o016: // ADD.W d(An,Xi),D0
			this.d0 = this.d0 & ~0xffff | this.add16(this.rop16(op), this.d0);
			break;
		...
		case 0o026: // ADD.L d(An,Xi),D0
			this.d0 = this.add32(this.rop32(op), this.d0);
			break;
		...
		case 0o040: // ADDX.B Dy,D0
			this.d0 = this.d0 & ~0xff | this.addx8(this.rop8(op), this.d0);
			break;
		case 0o041: // ADDX.B -(Ay),-(A0)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a0 = this.a0 - 1 | 0)), this.a0);
			break;
		...
		case 0o046: // ADD.B D0,d(An,Xi)
			this.rwop8(op, this.add8, this.d0);
			break;
		...
		case 0o050: // ADDX.W Dy,D0
			this.d0 = this.d0 & ~0xffff | this.addx16(this.rop16(op), this.d0);
			break;
		case 0o051: // ADDX.W -(Ay),-(A0)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a0 = this.a0 - 2 | 0)), this.a0);
			break;
		...
		case 0o056: // ADD.W D0,d(An,Xi)
			this.rwop16(op, this.add16, this.d0);
			break;
		...
		case 0o060: // ADDX.L Dy,D0
			this.d0 = this.addx32(this.rop32(op), this.d0);
			break;
		case 0o061: // ADDX.L -(Ay),-(A0)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a0 = this.a0 - 4 | 0)), this.a0);
			break;
		...
		case 0o066: // ADD.L D0,d(An,Xi)
			this.rwop32(op, this.add32, this.d0);
			break;
		...
		case 0o106: // ADD.B d(An,Xi),D1
			this.d1 = this.d1 & ~0xff | this.add8(this.rop8(op), this.d1);
			break;
		...
		case 0o116: // ADD.W d(An,Xi),D1
			this.d1 = this.d1 & ~0xffff | this.add16(this.rop16(op), this.d1);
			break;
		...
		case 0o126: // ADD.L d(An,Xi),D1
			this.d1 = this.add32(this.rop32(op), this.d1);
			break;
		...
		case 0o140: // ADDX.B Dy,D1
			this.d1 = this.d1 & ~0xff | this.addx8(this.rop8(op), this.d1);
			break;
		case 0o141: // ADDX.B -(Ay),-(A1)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a1 = this.a1 - 1 | 0)), this.a1);
			break;
		...
		case 0o146: // ADD.B D1,d(An,Xi)
			this.rwop8(op, this.add8, this.d1);
			break;
		...
		case 0o150: // ADDX.W Dy,D1
			this.d1 = this.d1 & ~0xffff | this.addx16(this.rop16(op), this.d1);
			break;
		case 0o151: // ADDX.W -(Ay),-(A1)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a1 = this.a1 - 2 | 0)), this.a1);
			break;
		...
		case 0o156: // ADD.W D1,d(An,Xi)
			this.rwop16(op, this.add16, this.d1);
			break;
		...
		case 0o160: // ADDX.L Dy,D1
			this.d1 = this.addx32(this.rop32(op), this.d1);
			break;
		case 0o161: // ADDX.L -(Ay),-(A1)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a1 = this.a1 - 4 | 0)), this.a1);
			break;
		...
		case 0o166: // ADD.L D1,d(An,Xi)
			this.rwop32(op, this.add32, this.d1);
			break;
		...
		case 0o206: // ADD.B d(An,Xi),D2
			this.d2 = this.d2 & ~0xff | this.add8(this.rop8(op), this.d2);
			break;
		...
		case 0o216: // ADD.W d(An,Xi),D2
			this.d2 = this.d2 & ~0xffff | this.add16(this.rop16(op), this.d2);
			break;
		...
		case 0o226: // ADD.L d(An,Xi),D2
			this.d2 = this.add32(this.rop32(op), this.d2);
			break;
		...
		case 0o240: // ADDX.B Dy,D2
			this.d2 = this.d2 & ~0xff | this.addx8(this.rop8(op), this.d2);
			break;
		case 0o241: // ADDX.B -(Ay),-(A2)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a2 = this.a2 - 1 | 0)), this.a2);
			break;
		...
		case 0o246: // ADD.B D2,d(An,Xi)
			this.rwop8(op, this.add8, this.d2);
			break;
		...
		case 0o250: // ADDX.W Dy,D2
			this.d2 = this.d2 & ~0xffff | this.addx16(this.rop16(op), this.d2);
			break;
		case 0o251: // ADDX.W -(Ay),-(A2)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a2 = this.a2 - 2 | 0)), this.a2);
			break;
		...
		case 0o256: // ADD.W D2,d(An,Xi)
			this.rwop16(op, this.add16, this.d2);
			break;
		...
		case 0o260: // ADDX.L Dy,D2
			this.d2 = this.addx32(this.rop32(op), this.d2);
			break;
		case 0o261: // ADDX.L -(Ay),-(A2)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a2 = this.a2 - 4 | 0)), this.a2);
			break;
		...
		case 0o266: // ADD.L D2,d(An,Xi)
			this.rwop32(op, this.add32, this.d2);
			break;
		...
		case 0o306: // ADD.B d(An,Xi),D3
			this.d3 = this.d3 & ~0xff | this.add8(this.rop8(op), this.d3);
			break;
		...
		case 0o316: // ADD.W d(An,Xi),D3
			this.d3 = this.d3 & ~0xffff | this.add16(this.rop16(op), this.d3);
			break;
		...
		case 0o326: // ADD.L d(An,Xi),D3
			this.d3 = this.add32(this.rop32(op), this.d3);
			break;
		...
		case 0o340: // ADDX.B Dy,D3
			this.d3 = this.d3 & ~0xff | this.addx8(this.rop8(op), this.d3);
			break;
		case 0o341: // ADDX.B -(Ay),-(A3)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a3 = this.a3 - 1 | 0)), this.a3);
			break;
		...
		case 0o346: // ADD.B D3,d(An,Xi)
			this.rwop8(op, this.add8, this.d3);
			break;
		...
		case 0o350: // ADDX.W Dy,D3
			this.d3 = this.d3 & ~0xffff | this.addx16(this.rop16(op), this.d3);
			break;
		case 0o351: // ADDX.W -(Ay),-(A3)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a3 = this.a3 - 2 | 0)), this.a3);
			break;
		...
		case 0o356: // ADD.W D3,d(An,Xi)
			this.rwop16(op, this.add16, this.d3);
			break;
		...
		case 0o360: // ADDX.L Dy,D3
			this.d3 = this.addx32(this.rop32(op), this.d3);
			break;
		case 0o361: // ADDX.L -(Ay),-(A3)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a3 = this.a3 - 4 | 0)), this.a3);
			break;
		...
		case 0o366: // ADD.L D3,d(An,Xi)
			this.rwop32(op, this.add32, this.d3);
			break;
		...
		case 0o406: // ADD.B d(An,Xi),D4
			this.d4 = this.d4 & ~0xff | this.add8(this.rop8(op), this.d4);
			break;
		...
		case 0o416: // ADD.W d(An,Xi),D4
			this.d4 = this.d4 & ~0xffff | this.add16(this.rop16(op), this.d4);
			break;
		...
		case 0o426: // ADD.L d(An,Xi),D4
			this.d4 = this.add32(this.rop32(op), this.d4);
			break;
		...
		case 0o440: // ADDX.B Dy,D4
			this.d4 = this.d4 & ~0xff | this.addx8(this.rop8(op), this.d4);
			break;
		case 0o441: // ADDX.B -(Ay),-(A4)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a4 = this.a4 - 1 | 0)), this.a4);
			break;
		...
		case 0o446: // ADD.B D4,d(An,Xi)
			this.rwop8(op, this.add8, this.d4);
			break;
		...
		case 0o450: // ADDX.W Dy,D4
			this.d4 = this.d4 & ~0xffff | this.addx16(this.rop16(op), this.d4);
			break;
		case 0o451: // ADDX.W -(Ay),-(A4)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a4 = this.a4 - 2 | 0)), this.a4);
			break;
		...
		case 0o456: // ADD.W D4,d(An,Xi)
			this.rwop16(op, this.add16, this.d4);
			break;
		...
		case 0o460: // ADDX.L Dy,D4
			this.d4 = this.addx32(this.rop32(op), this.d4);
			break;
		case 0o461: // ADDX.L -(Ay),-(A4)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a4 = this.a4 - 4 | 0)), this.a4);
			break;
		...
		case 0o466: // ADD.L D4,d(An,Xi)
			this.rwop32(op, this.add32, this.d4);
			break;
		...
		case 0o506: // ADD.B d(An,Xi),D5
			this.d5 = this.d5 & ~0xff | this.add8(this.rop8(op), this.d5);
			break;
		...
		case 0o516: // ADD.W d(An,Xi),D5
			this.d5 = this.d5 & ~0xffff | this.add16(this.rop16(op), this.d5);
			break;
		...
		case 0o526: // ADD.L d(An,Xi),D5
			this.d5 = this.add32(this.rop32(op), this.d5);
			break;
		...
		case 0o540: // ADDX.B Dy,D5
			this.d5 = this.d5 & ~0xff | this.addx8(this.rop8(op), this.d5);
			break;
		case 0o541: // ADDX.B -(Ay),-(A5)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a5 = this.a5 - 1 | 0)), this.a5);
			break;
		...
		case 0o546: // ADD.B D5,d(An,Xi)
			this.rwop8(op, this.add8, this.d5);
			break;
		...
		case 0o550: // ADDX.W Dy,D5
			this.d5 = this.d5 & ~0xffff | this.addx16(this.rop16(op), this.d5);
			break;
		case 0o551: // ADDX.W -(Ay),-(A5)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a5 = this.a5 - 2 | 0)), this.a5);
			break;
		...
		case 0o556: // ADD.W D5,d(An,Xi)
			this.rwop16(op, this.add16, this.d5);
			break;
		...
		case 0o560: // ADDX.L Dy,D5
			this.d5 = this.addx32(this.rop32(op), this.d5);
			break;
		case 0o561: // ADDX.L -(Ay),-(A5)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a5 = this.a5 - 4 | 0)), this.a5);
			break;
		...
		case 0o566: // ADD.L D5,d(An,Xi)
			this.rwop32(op, this.add32, this.d5);
			break;
		...
		case 0o606: // ADD.B d(An,Xi),D6
			this.d6 = this.d6 & ~0xff | this.add8(this.rop8(op), this.d6);
			break;
		...
		case 0o616: // ADD.W d(An,Xi),D6
			this.d6 = this.d6 & ~0xffff | this.add16(this.rop16(op), this.d6);
			break;
		...
		case 0o626: // ADD.L d(An,Xi),D6
			this.d6 = this.add32(this.rop32(op), this.d6);
			break;
		...
		case 0o640: // ADDX.B Dy,D6
			this.d6 = this.d6 & ~0xff | this.addx8(this.rop8(op), this.d6);
			break;
		case 0o641: // ADDX.B -(Ay),-(A6)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a6 = this.a6 - 1 | 0)), this.a6);
			break;
		...
		case 0o646: // ADD.B D6,d(An,Xi)
			this.rwop8(op, this.add8, this.d6);
			break;
		...
		case 0o650: // ADDX.W Dy,D6
			this.d6 = this.d6 & ~0xffff | this.addx16(this.rop16(op), this.d6);
			break;
		case 0o651: // ADDX.W -(Ay),-(A6)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a6 = this.a6 - 2 | 0)), this.a6);
			break;
		...
		case 0o656: // ADD.W D6,d(An,Xi)
			this.rwop16(op, this.add16, this.d6);
			break;
		...
		case 0o660: // ADDX.L Dy,D6
			this.d6 = this.addx32(this.rop32(op), this.d6);
			break;
		case 0o661: // ADDX.L -(Ay),-(A6)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a6 = this.a6 - 4 | 0)), this.a6);
			break;
		...
		case 0o666: // ADD.L D6,d(An,Xi)
			this.rwop32(op, this.add32, this.d6);
			break;
		...
		case 0o706: // ADD.B d(An,Xi),D7
			this.d7 = this.d7 & ~0xff | this.add8(this.rop8(op), this.d7);
			break;
		...
		case 0o716: // ADD.W d(An,Xi),D7
			this.d7 = this.d7 & ~0xffff | this.add16(this.rop16(op), this.d7);
			break;
		...
		case 0o726: // ADD.L d(An,Xi),D7
			this.d7 = this.add32(this.rop32(op), this.d7);
			break;
		...
		case 0o740: // ADDX.B Dy,D7
			this.d7 = this.d7 & ~0xff | this.addx8(this.rop8(op), this.d7);
			break;
		case 0o741: // ADDX.B -(Ay),-(A7)
			this.write8(this.addx8(this.rop8(op & 7 | 0o40), this.read8(this.a7 = this.a7 - 1 | 0)), this.a7);
			break;
		...
		case 0o746: // ADD.B D7,d(An,Xi)
			this.rwop8(op, this.add8, this.d7);
			break;
		...
		case 0o750: // ADDX.W Dy,D7
			this.d7 = this.d7 & ~0xffff | this.addx16(this.rop16(op), this.d7);
			break;
		case 0o751: // ADDX.W -(Ay),-(A7)
			this.write16(this.addx16(this.rop16(op & 7 | 0o40), this.read16(this.a7 = this.a7 - 2 | 0)), this.a7);
			break;
		...
		case 0o756: // ADD.W D7,d(An,Xi)
			this.rwop16(op, this.add16, this.d7);
			break;
		...
		case 0o760: // ADDX.L Dy,D7
			this.d7 = this.addx32(this.rop32(op), this.d7);
			break;
		case 0o761: // ADDX.L -(Ay),-(A7)
			this.write32(this.addx32(this.rop32(op & 7 | 0o40), this.read32(this.a7 = this.a7 - 4 | 0)), this.a7);
			break;
		...
		case 0o766: // ADD.L D7,d(An,Xi)
			this.rwop32(op, this.add32, this.d7);
			break;
	...
	execute_e(op) {
		...
		case 0o000: // ASR.B #8,Dy
			this.rwop8(op & 7, this.asr8, 8);
			break;
		case 0o001: // LSR.B #8,Dy
			this.rwop8(op & 7, this.lsr8, 8);
			break;
		case 0o002: // ROXR.B #8,Dy
			this.rwop8(op & 7, this.roxr8, 8);
			break;
		case 0o003: // ROR.B #8,Dy
			this.rwop8(op & 7, this.ror8, 8);
			break;
		case 0o004: // ASR.B D0,Dy
			this.rwop8(op & 7, this.asr8, this.d0);
			break;
		case 0o005: // LSR.B D0,Dy
			this.rwop8(op & 7, this.lsr8, this.d0);
			break;
		case 0o006: // ROXR.B D0,Dy
			this.rwop8(op & 7, this.roxr8, this.d0);
			break;
		case 0o007: // ROR.B D0,Dy
			this.rwop8(op & 7, this.ror8, this.d0);
			break;
		case 0o010: // ASR.W #8,Dy
			this.rwop16(op & 7, this.asr16, 8);
			break;
		case 0o011: // LSR.W #8,Dy
			this.rwop16(op & 7, this.lsr16, 8);
			break;
		case 0o012: // ROXR.W #8,Dy
			this.rwop16(op & 7, this.roxr16, 8);
			break;
		case 0o013: // ROR.W #8,Dy
			this.rwop16(op & 7, this.ror16, 8);
			break;
		case 0o014: // ASR.W D0,Dy
			this.rwop16(op & 7, this.asr16, this.d0);
			break;
		case 0o015: // LSR.W D0,Dy
			this.rwop16(op & 7, this.lsr16, this.d0);
			break;
		case 0o016: // ROXR.W D0,Dy
			this.rwop16(op & 7, this.roxr16, this.d0);
			break;
		case 0o017: // ROR.W D0,Dy
			this.rwop16(op & 7, this.ror16, this.d0);
			break;
		case 0o020: // ASR.L #8,Dy
			this.rwop32(op & 7, this.asr32, 8);
			break;
		case 0o021: // LSR.L #8,Dy
			this.rwop32(op & 7, this.lsr32, 8);
			break;
		case 0o022: // ROXR.L #8,Dy
			this.rwop32(op & 7, this.roxr32, 8);
			break;
		case 0o023: // ROR.L #8,Dy
			this.rwop32(op & 7, this.ror32, 8);
			break;
		case 0o024: // ASR.L D0,Dy
			this.rwop32(op & 7, this.asr32, this.d0);
			break;
		case 0o025: // LSR.L D0,Dy
			this.rwop32(op & 7, this.lsr32, this.d0);
			break;
		case 0o026: // ROXR.L D0,Dy
			this.rwop32(op & 7, this.roxr32, this.d0);
			break;
		case 0o027: // ROR.L D0,Dy
			this.rwop32(op & 7, this.ror32, this.d0);
			break;
		case 0o032: // ASR.W (An)
		case 0o033: // ASR.W (An)+
		case 0o034: // ASR.W -(An)
		...
		case 0o040: // ASL.B #8,Dy
			this.rwop8(op & 7, this.asl8, 8);
			break;
		case 0o041: // LSL.B #8,Dy
			this.rwop8(op & 7, this.lsl8, 8);
			break;
		case 0o042: // ROXL.B #8,Dy
			this.rwop8(op & 7, this.roxl8, 8);
			break;
		case 0o043: // ROL.B #8,Dy
			this.rwop8(op & 7, this.rol8, 8);
			break;
		case 0o044: // ASL.B D0,Dy
			this.rwop8(op & 7, this.asl8, this.d0);
			break;
		case 0o045: // LSL.B D0,Dy
			this.rwop8(op & 7, this.lsl8, this.d0);
			break;
		case 0o046: // ROXL.B D0,Dy
			this.rwop8(op & 7, this.roxl8, this.d0);
			break;
		case 0o047: // ROL.B D0,Dy
			this.rwop8(op & 7, this.rol8, this.d0);
			break;
		case 0o050: // ASL.W #8,Dy
			this.rwop16(op & 7, this.asl16, 8);
			break;
		case 0o051: // LSL.W #8,Dy
			this.rwop16(op & 7, this.lsl16, 8);
			break;
		case 0o052: // ROXL.W #8,Dy
			this.rwop16(op & 7, this.roxl16, 8);
			break;
		case 0o053: // ROL.W #8,Dy
			this.rwop16(op & 7, this.rol16, 8);
			break;
		case 0o054: // ASL.W D0,Dy
			this.rwop16(op & 7, this.asl16, this.d0);
			break;
		case 0o055: // LSL.W D0,Dy
			this.rwop16(op & 7, this.lsl16, this.d0);
			break;
		case 0o056: // ROXL.W D0,Dy
			this.rwop16(op & 7, this.roxl16, this.d0);
			break;
		case 0o057: // ROL.W D0,Dy
			this.rwop16(op & 7, this.rol16, this.d0);
			break;
		case 0o060: // ASL.L #8,Dy
			this.rwop32(op & 7, this.asl32, 8);
			break;
		case 0o061: // LSL.L #8,Dy
			this.rwop32(op & 7, this.lsl32, 8);
			break;
		case 0o062: // ROXL.L #8,Dy
			this.rwop32(op & 7, this.roxl32, 8);
			break;
		case 0o063: // ROL.L #8,Dy
			this.rwop32(op & 7, this.rol32, 8);
			break;
		case 0o064: // ASL.L D0,Dy
			this.rwop32(op & 7, this.asl32, this.d0);
			break;
		case 0o065: // LSL.L D0,Dy
			this.rwop32(op & 7, this.lsl32, this.d0);
			break;
		case 0o066: // ROXL.L D0,Dy
			this.rwop32(op & 7, this.roxl32, this.d0);
			break;
		case 0o067: // ROL.L D0,Dy
			this.rwop32(op & 7, this.rol32, this.d0);
			break;
		case 0o072: // ASL.W (An)
		case 0o073: // ASL.W (An)+
		case 0o074: // ASL.W -(An)
		...
		case 0o100: // ASR.B #1,Dy
			this.rwop8(op & 7, this.asr8, 1);
			break;
		case 0o101: // LSR.B #1,Dy
			this.rwop8(op & 7, this.lsr8, 1);
			break;
		case 0o102: // ROXR.B #1,Dy
			this.rwop8(op & 7, this.roxr8, 1);
			break;
		case 0o103: // ROR.B #1,Dy
			this.rwop8(op & 7, this.ror8, 1);
			break;
		case 0o104: // ASR.B D1,Dy
			this.rwop8(op & 7, this.asr8, this.d1);
			break;
		case 0o105: // LSR.B D1,Dy
			this.rwop8(op & 7, this.lsr8, this.d1);
			break;
		case 0o106: // ROXR.B D1,Dy
			this.rwop8(op & 7, this.roxr8, this.d1);
			break;
		case 0o107: // ROR.B D1,Dy
			this.rwop8(op & 7, this.ror8, this.d1);
			break;
		case 0o110: // ASR.W #1,Dy
			this.rwop16(op & 7, this.asr16, 1);
			break;
		case 0o111: // LSR.W #1,Dy
			this.rwop16(op & 7, this.lsr16, 1);
			break;
		case 0o112: // ROXR.W #1,Dy
			this.rwop16(op & 7, this.roxr16, 1);
			break;
		case 0o113: // ROR.W #1,Dy
			this.rwop16(op & 7, this.ror16, 1);
			break;
		case 0o114: // ASR.W D1,Dy
			this.rwop16(op & 7, this.asr16, this.d1);
			break;
		case 0o115: // LSR.W D1,Dy
			this.rwop16(op & 7, this.lsr16, this.d1);
			break;
		case 0o116: // ROXR.W D1,Dy
			this.rwop16(op & 7, this.roxr16, this.d1);
			break;
		case 0o117: // ROR.W D1,Dy
			this.rwop16(op & 7, this.ror16, this.d1);
			break;
		case 0o120: // ASR.L #1,Dy
			this.rwop32(op & 7, this.asr32, 1);
			break;
		case 0o121: // LSR.L #1,Dy
			this.rwop32(op & 7, this.lsr32, 1);
			break;
		case 0o122: // ROXR.L #1,Dy
			this.rwop32(op & 7, this.roxr32, 1);
			break;
		case 0o123: // ROR.L #1,Dy
			this.rwop32(op & 7, this.ror32, 1);
			break;
		case 0o124: // ASR.L D1,Dy
			this.rwop32(op & 7, this.asr32, this.d1);
			break;
		case 0o125: // LSR.L D1,Dy
			this.rwop32(op & 7, this.lsr32, this.d1);
			break;
		case 0o126: // ROXR.L D1,Dy
			this.rwop32(op & 7, this.roxr32, this.d1);
			break;
		case 0o127: // ROR.L D1,Dy
			this.rwop32(op & 7, this.ror32, this.d1);
			break;
		case 0o132: // LSR.W (An)
		case 0o133: // LSR.W (An)+
		case 0o134: // LSR.W -(An)
		...
		case 0o140: // ASL.B #1,Dy
			this.rwop8(op & 7, this.asl8, 1);
			break;
		case 0o141: // LSL.B #1,Dy
			this.rwop8(op & 7, this.lsl8, 1);
			break;
		case 0o142: // ROXL.B #1,Dy
			this.rwop8(op & 7, this.roxl8, 1);
			break;
		case 0o143: // ROL.B #1,Dy
			this.rwop8(op & 7, this.rol8, 1);
			break;
		case 0o144: // ASL.B D1,Dy
			this.rwop8(op & 7, this.asl8, this.d1);
			break;
		case 0o145: // LSL.B D1,Dy
			this.rwop8(op & 7, this.lsl8, this.d1);
			break;
		case 0o146: // ROXL.B D1,Dy
			this.rwop8(op & 7, this.roxl8, this.d1);
			break;
		case 0o147: // ROL.B D1,Dy
			this.rwop8(op & 7, this.rol8, this.d1);
			break;
		case 0o150: // ASL.W #1,Dy
			this.rwop16(op & 7, this.asl16, 1);
			break;
		case 0o151: // LSL.W #1,Dy
			this.rwop16(op & 7, this.lsl16, 1);
			break;
		case 0o152: // ROXL.W #1,Dy
			this.rwop16(op & 7, this.roxl16, 1);
			break;
		case 0o153: // ROL.W #1,Dy
			this.rwop16(op & 7, this.rol16, 1);
			break;
		case 0o154: // ASL.W D1,Dy
			this.rwop16(op & 7, this.asl16, this.d1);
			break;
		case 0o155: // LSL.W D1,Dy
			this.rwop16(op & 7, this.lsl16, this.d1);
			break;
		case 0o156: // ROXL.W D1,Dy
			this.rwop16(op & 7, this.roxl16, this.d1);
			break;
		case 0o157: // ROL.W D1,Dy
			this.rwop16(op & 7, this.rol16, this.d1);
			break;
		case 0o160: // ASL.L #1,Dy
			this.rwop32(op & 7, this.asl32, 1);
			break;
		case 0o161: // LSL.L #1,Dy
			this.rwop32(op & 7, this.lsl32, 1);
			break;
		case 0o162: // ROXL.L #1,Dy
			this.rwop32(op & 7, this.roxl32, 1);
			break;
		case 0o163: // ROL.L #1,Dy
			this.rwop32(op & 7, this.rol32, 1);
			break;
		case 0o164: // ASL.L D1,Dy
			this.rwop32(op & 7, this.asl32, this.d1);
			break;
		case 0o165: // LSL.L D1,Dy
			this.rwop32(op & 7, this.lsl32, this.d1);
			break;
		case 0o166: // ROXL.L D1,Dy
			this.rwop32(op & 7, this.roxl32, this.d1);
			break;
		case 0o167: // ROL.L D1,Dy
			this.rwop32(op & 7, this.rol32, this.d1);
			break;
		case 0o172: // LSL.W (An)
		case 0o173: // LSL.W (An)+
		case 0o174: // LSL.W -(An)
		...
		case 0o200: // ASR.B #2,Dy
			this.rwop8(op & 7, this.asr8, 2);
			break;
		case 0o201: // LSR.B #2,Dy
			this.rwop8(op & 7, this.lsr8, 2);
			break;
		case 0o202: // ROXR.B #2,Dy
			this.rwop8(op & 7, this.roxr8, 2);
			break;
		case 0o203: // ROR.B #2,Dy
			this.rwop8(op & 7, this.ror8, 2);
			break;
		case 0o204: // ASR.B D2,Dy
			this.rwop8(op & 7, this.asr8, this.d2);
			break;
		case 0o205: // LSR.B D2,Dy
			this.rwop8(op & 7, this.lsr8, this.d2);
			break;
		case 0o206: // ROXR.B D2,Dy
			this.rwop8(op & 7, this.roxr8, this.d2);
			break;
		case 0o207: // ROR.B D2,Dy
			this.rwop8(op & 7, this.ror8, this.d2);
			break;
		case 0o210: // ASR.W #2,Dy
			this.rwop16(op & 7, this.asr16, 2);
			break;
		case 0o211: // LSR.W #2,Dy
			this.rwop16(op & 7, this.lsr16, 2);
			break;
		case 0o212: // ROXR.W #2,Dy
			this.rwop16(op & 7, this.roxr16, 2);
			break;
		case 0o213: // ROR.W #2,Dy
			this.rwop16(op & 7, this.ror16, 2);
			break;
		case 0o214: // ASR.W D2,Dy
			this.rwop16(op & 7, this.asr16, this.d2);
			break;
		case 0o215: // LSR.W D2,Dy
			this.rwop16(op & 7, this.lsr16, this.d2);
			break;
		case 0o216: // ROXR.W D2,Dy
			this.rwop16(op & 7, this.roxr16, this.d2);
			break;
		case 0o217: // ROR.W D2,Dy
			this.rwop16(op & 7, this.ror16, this.d2);
			break;
		case 0o220: // ASR.L #2,Dy
			this.rwop32(op & 7, this.asr32, 2);
			break;
		case 0o221: // LSR.L #2,Dy
			this.rwop32(op & 7, this.lsr32, 2);
			break;
		case 0o222: // ROXR.L #2,Dy
			this.rwop32(op & 7, this.roxr32, 2);
			break;
		case 0o223: // ROR.L #2,Dy
			this.rwop32(op & 7, this.ror32, 2);
			break;
		case 0o224: // ASR.L D2,Dy
			this.rwop32(op & 7, this.asr32, this.d2);
			break;
		case 0o225: // LSR.L D2,Dy
			this.rwop32(op & 7, this.lsr32, this.d2);
			break;
		case 0o226: // ROXR.L D2,Dy
			this.rwop32(op & 7, this.roxr32, this.d2);
			break;
		case 0o227: // ROR.L D2,Dy
			this.rwop32(op & 7, this.ror32, this.d2);
			break;
		...
		case 0o240: // ASL.B #2,Dy
			this.rwop8(op & 7, this.asl8, 2);
			break;
		case 0o241: // LSL.B #2,Dy
			this.rwop8(op & 7, this.lsl8, 2);
			break;
		case 0o242: // ROXL.B #2,Dy
			this.rwop8(op & 7, this.roxl8, 2);
			break;
		case 0o243: // ROL.B #2,Dy
			this.rwop8(op & 7, this.rol8, 2);
			break;
		case 0o244: // ASL.B D2,Dy
			this.rwop8(op & 7, this.asl8, this.d2);
			break;
		case 0o245: // LSL.B D2,Dy
			this.rwop8(op & 7, this.lsl8, this.d2);
			break;
		case 0o246: // ROXL.B D2,Dy
			this.rwop8(op & 7, this.roxl8, this.d2);
			break;
		case 0o247: // ROL.B D2,Dy
			this.rwop8(op & 7, this.rol8, this.d2);
			break;
		case 0o250: // ASL.W #2,Dy
			this.rwop16(op & 7, this.asl16, 2);
			break;
		case 0o251: // LSL.W #2,Dy
			this.rwop16(op & 7, this.lsl16, 2);
			break;
		case 0o252: // ROXL.W #2,Dy
			this.rwop16(op & 7, this.roxl16, 2);
			break;
		case 0o253: // ROL.W #2,Dy
			this.rwop16(op & 7, this.rol16, 2);
			break;
		case 0o254: // ASL.W D2,Dy
			this.rwop16(op & 7, this.asl16, this.d2);
			break;
		case 0o255: // LSL.W D2,Dy
			this.rwop16(op & 7, this.lsl16, this.d2);
			break;
		case 0o256: // ROXL.W D2,Dy
			this.rwop16(op & 7, this.roxl16, this.d2);
			break;
		case 0o257: // ROL.W D2,Dy
			this.rwop16(op & 7, this.rol16, this.d2);
			break;
		case 0o260: // ASL.L #2,Dy
			this.rwop32(op & 7, this.asl32, 2);
			break;
		case 0o261: // LSL.L #2,Dy
			this.rwop32(op & 7, this.lsl32, 2);
			break;
		case 0o262: // ROXL.L #2,Dy
			this.rwop32(op & 7, this.roxl32, 2);
			break;
		case 0o263: // ROL.L #2,Dy
			this.rwop32(op & 7, this.rol32, 2);
			break;
		case 0o264: // ASL.L D2,Dy
			this.rwop32(op & 7, this.asl32, this.d2);
			break;
		case 0o265: // LSL.L D2,Dy
			this.rwop32(op & 7, this.lsl32, this.d2);
			break;
		case 0o266: // ROXL.L D2,Dy
			this.rwop32(op & 7, this.roxl32, this.d2);
			break;
		case 0o267: // ROL.L D2,Dy
			this.rwop32(op & 7, this.rol32, this.d2);
			break;
		...
		case 0o300: // ASR.B #3,Dy
			this.rwop8(op & 7, this.asr8, 3);
			break;
		case 0o301: // LSR.B #3,Dy
			this.rwop8(op & 7, this.lsr8, 3);
			break;
		case 0o302: // ROXR.B #3,Dy
			this.rwop8(op & 7, this.roxr8, 3);
			break;
		case 0o303: // ROR.B #3,Dy
			this.rwop8(op & 7, this.ror8, 3);
			break;
		case 0o304: // ASR.B D3,Dy
			this.rwop8(op & 7, this.asr8, this.d3);
			break;
		case 0o305: // LSR.B D3,Dy
			this.rwop8(op & 7, this.lsr8, this.d3);
			break;
		case 0o306: // ROXR.B D3,Dy
			this.rwop8(op & 7, this.roxr8, this.d3);
			break;
		case 0o307: // ROR.B D3,Dy
			this.rwop8(op & 7, this.ror8, this.d3);
			break;
		case 0o310: // ASR.W #3,Dy
			this.rwop16(op & 7, this.asr16, 3);
			break;
		case 0o311: // LSR.W #3,Dy
			this.rwop16(op & 7, this.lsr16, 3);
			break;
		case 0o312: // ROXR.W #3,Dy
			this.rwop16(op & 7, this.roxr16, 3);
			break;
		case 0o313: // ROR.W #3,Dy
			this.rwop16(op & 7, this.ror16, 3);
			break;
		case 0o314: // ASR.W D3,Dy
			this.rwop16(op & 7, this.asr16, this.d3);
			break;
		case 0o315: // LSR.W D3,Dy
			this.rwop16(op & 7, this.lsr16, this.d3);
			break;
		case 0o316: // ROXR.W D3,Dy
			this.rwop16(op & 7, this.roxr16, this.d3);
			break;
		case 0o317: // ROR.W D3,Dy
			this.rwop16(op & 7, this.ror16, this.d3);
			break;
		case 0o320: // ASR.L #3,Dy
			this.rwop32(op & 7, this.asr32, 3);
			break;
		case 0o321: // LSR.L #3,Dy
			this.rwop32(op & 7, this.lsr32, 3);
			break;
		case 0o322: // ROXR.L #3,Dy
			this.rwop32(op & 7, this.roxr32, 3);
			break;
		case 0o323: // ROR.L #3,Dy
			this.rwop32(op & 7, this.ror32, 3);
			break;
		case 0o324: // ASR.L D3,Dy
			this.rwop32(op & 7, this.asr32, this.d3);
			break;
		case 0o325: // LSR.L D3,Dy
			this.rwop32(op & 7, this.lsr32, this.d3);
			break;
		case 0o326: // ROXR.L D3,Dy
			this.rwop32(op & 7, this.roxr32, this.d3);
			break;
		case 0o327: // ROR.L D3,Dy
			this.rwop32(op & 7, this.ror32, this.d3);
			break;
		case 0o332: // ROR.W (An)
		case 0o333: // ROR.W (An)+
		case 0o334: // ROR.W -(An)
		...
		case 0o340: // ASL.B #3,Dy
			this.rwop8(op & 7, this.asl8, 3);
			break;
		case 0o341: // LSL.B #3,Dy
			this.rwop8(op & 7, this.lsl8, 3);
			break;
		case 0o342: // ROXL.B #3,Dy
			this.rwop8(op & 7, this.roxl8, 3);
			break;
		case 0o343: // ROL.B #3,Dy
			this.rwop8(op & 7, this.rol8, 3);
			break;
		case 0o344: // ASL.B D3,Dy
			this.rwop8(op & 7, this.asl8, this.d3);
			break;
		case 0o345: // LSL.B D3,Dy
			this.rwop8(op & 7, this.lsl8, this.d3);
			break;
		case 0o346: // ROXL.B D3,Dy
			this.rwop8(op & 7, this.roxl8, this.d3);
			break;
		case 0o347: // ROL.B D3,Dy
			this.rwop8(op & 7, this.rol8, this.d3);
			break;
		case 0o350: // ASL.W #3,Dy
			this.rwop16(op & 7, this.asl16, 3);
			break;
		case 0o351: // LSL.W #3,Dy
			this.rwop16(op & 7, this.lsl16, 3);
			break;
		case 0o352: // ROXL.W #3,Dy
			this.rwop16(op & 7, this.roxl16, 3);
			break;
		case 0o353: // ROL.W #3,Dy
			this.rwop16(op & 7, this.rol16, 3);
			break;
		case 0o354: // ASL.W D3,Dy
			this.rwop16(op & 7, this.asl16, this.d3);
			break;
		case 0o355: // LSL.W D3,Dy
			this.rwop16(op & 7, this.lsl16, this.d3);
			break;
		case 0o356: // ROXL.W D3,Dy
			this.rwop16(op & 7, this.roxl16, this.d3);
			break;
		case 0o357: // ROL.W D3,Dy
			this.rwop16(op & 7, this.rol16, this.d3);
			break;
		case 0o360: // ASL.L #3,Dy
			this.rwop32(op & 7, this.asl32, 3);
			break;
		case 0o361: // LSL.L #3,Dy
			this.rwop32(op & 7, this.lsl32, 3);
			break;
		case 0o362: // ROXL.L #3,Dy
			this.rwop32(op & 7, this.roxl32, 3);
			break;
		case 0o363: // ROL.L #3,Dy
			this.rwop32(op & 7, this.rol32, 3);
			break;
		case 0o364: // ASL.L D3,Dy
			this.rwop32(op & 7, this.asl32, this.d3);
			break;
		case 0o365: // LSL.L D3,Dy
			this.rwop32(op & 7, this.lsl32, this.d3);
			break;
		case 0o366: // ROXL.L D3,Dy
			this.rwop32(op & 7, this.roxl32, this.d3);
			break;
		case 0o367: // ROL.L D3,Dy
			this.rwop32(op & 7, this.rol32, this.d3);
			break;
		case 0o372: // ROL.W (An)
		case 0o373: // ROL.W (An)+
		case 0o374: // ROL.W -(An)
		...
		case 0o400: // ASR.B #4,Dy
			this.rwop8(op & 7, this.asr8, 4);
			break;
		case 0o401: // LSR.B #4,Dy
			this.rwop8(op & 7, this.lsr8, 4);
			break;
		case 0o402: // ROXR.B #4,Dy
			this.rwop8(op & 7, this.roxr8, 4);
			break;
		case 0o403: // ROR.B #4,Dy
			this.rwop8(op & 7, this.ror8, 4);
			break;
		case 0o404: // ASR.B D4,Dy
			this.rwop8(op & 7, this.asr8, this.d4);
			break;
		case 0o405: // LSR.B D4,Dy
			this.rwop8(op & 7, this.lsr8, this.d4);
			break;
		case 0o406: // ROXR.B D4,Dy
			this.rwop8(op & 7, this.roxr8, this.d4);
			break;
		case 0o407: // ROR.B D4,Dy
			this.rwop8(op & 7, this.ror8, this.d4);
			break;
		case 0o410: // ASR.W #4,Dy
			this.rwop16(op & 7, this.asr16, 4);
			break;
		case 0o411: // LSR.W #4,Dy
			this.rwop16(op & 7, this.lsr16, 4);
			break;
		case 0o412: // ROXR.W #4,Dy
			this.rwop16(op & 7, this.roxr16, 4);
			break;
		case 0o413: // ROR.W #4,Dy
			this.rwop16(op & 7, this.ror16, 4);
			break;
		case 0o414: // ASR.W D4,Dy
			this.rwop16(op & 7, this.asr16, this.d4);
			break;
		case 0o415: // LSR.W D4,Dy
			this.rwop16(op & 7, this.lsr16, this.d4);
			break;
		case 0o416: // ROXR.W D4,Dy
			this.rwop16(op & 7, this.roxr16, this.d4);
			break;
		case 0o417: // ROR.W D4,Dy
			this.rwop16(op & 7, this.ror16, this.d4);
			break;
		case 0o420: // ASR.L #4,Dy
			this.rwop32(op & 7, this.asr32, 4);
			break;
		case 0o421: // LSR.L #4,Dy
			this.rwop32(op & 7, this.lsr32, 4);
			break;
		case 0o422: // ROXR.L #4,Dy
			this.rwop32(op & 7, this.roxr32, 4);
			break;
		case 0o423: // ROR.L #4,Dy
			this.rwop32(op & 7, this.ror32, 4);
			break;
		case 0o424: // ASR.L D4,Dy
			this.rwop32(op & 7, this.asr32, this.d4);
			break;
		case 0o425: // LSR.L D4,Dy
			this.rwop32(op & 7, this.lsr32, this.d4);
			break;
		case 0o426: // ROXR.L D4,Dy
			this.rwop32(op & 7, this.roxr32, this.d4);
			break;
		case 0o427: // ROR.L D4,Dy
			this.rwop32(op & 7, this.ror32, this.d4);
			break;
		case 0o440: // ASL.B #4,Dy
			this.rwop8(op & 7, this.asl8, 4);
			break;
		case 0o441: // LSL.B #4,Dy
			this.rwop8(op & 7, this.lsl8, 4);
			break;
		case 0o442: // ROXL.B #4,Dy
			this.rwop8(op & 7, this.roxl8, 4);
			break;
		case 0o443: // ROL.B #4,Dy
			this.rwop8(op & 7, this.rol8, 4);
			break;
		case 0o444: // ASL.B D4,Dy
			this.rwop8(op & 7, this.asl8, this.d4);
			break;
		case 0o445: // LSL.B D4,Dy
			this.rwop8(op & 7, this.lsl8, this.d4);
			break;
		case 0o446: // ROXL.B D4,Dy
			this.rwop8(op & 7, this.roxl8, this.d4);
			break;
		case 0o447: // ROL.B D4,Dy
			this.rwop8(op & 7, this.rol8, this.d4);
			break;
		case 0o450: // ASL.W #4,Dy
			this.rwop16(op & 7, this.asl16, 4);
			break;
		case 0o451: // LSL.W #4,Dy
			this.rwop16(op & 7, this.lsl16, 4);
			break;
		case 0o452: // ROXL.W #4,Dy
			this.rwop16(op & 7, this.roxl16, 4);
			break;
		case 0o453: // ROL.W #4,Dy
			this.rwop16(op & 7, this.rol16, 4);
			break;
		case 0o454: // ASL.W D4,Dy
			this.rwop16(op & 7, this.asl16, this.d4);
			break;
		case 0o455: // LSL.W D4,Dy
			this.rwop16(op & 7, this.lsl16, this.d4);
			break;
		case 0o456: // ROXL.W D4,Dy
			this.rwop16(op & 7, this.roxl16, this.d4);
			break;
		case 0o457: // ROL.W D4,Dy
			this.rwop16(op & 7, this.rol16, this.d4);
			break;
		case 0o460: // ASL.L #4,Dy
			this.rwop32(op & 7, this.asl32, 4);
			break;
		case 0o461: // LSL.L #4,Dy
			this.rwop32(op & 7, this.lsl32, 4);
			break;
		case 0o462: // ROXL.L #4,Dy
			this.rwop32(op & 7, this.roxl32, 4);
			break;
		case 0o463: // ROL.L #4,Dy
			this.rwop32(op & 7, this.rol32, 4);
			break;
		case 0o464: // ASL.L D4,Dy
			this.rwop32(op & 7, this.asl32, this.d4);
			break;
		case 0o465: // LSL.L D4,Dy
			this.rwop32(op & 7, this.lsl32, this.d4);
			break;
		case 0o466: // ROXL.L D4,Dy
			this.rwop32(op & 7, this.roxl32, this.d4);
			break;
		case 0o467: // ROL.L D4,Dy
			this.rwop32(op & 7, this.rol32, this.d4);
			break;
		case 0o500: // ASR.B #5,Dy
			this.rwop8(op & 7, this.asr8, 5);
			break;
		case 0o501: // LSR.B #5,Dy
			this.rwop8(op & 7, this.lsr8, 5);
			break;
		case 0o502: // ROXR.B #5,Dy
			this.rwop8(op & 7, this.roxr8, 5);
			break;
		case 0o503: // ROR.B #5,Dy
			this.rwop8(op & 7, this.ror8, 5);
			break;
		case 0o504: // ASR.B D5,Dy
			this.rwop8(op & 7, this.asr8, this.d5);
			break;
		case 0o505: // LSR.B D5,Dy
			this.rwop8(op & 7, this.lsr8, this.d5);
			break;
		case 0o506: // ROXR.B D5,Dy
			this.rwop8(op & 7, this.roxr8, this.d5);
			break;
		case 0o507: // ROR.B D5,Dy
			this.rwop8(op & 7, this.ror8, this.d5);
			break;
		case 0o510: // ASR.W #5,Dy
			this.rwop16(op & 7, this.asr16, 5);
			break;
		case 0o511: // LSR.W #5,Dy
			this.rwop16(op & 7, this.lsr16, 5);
			break;
		case 0o512: // ROXR.W #5,Dy
			this.rwop16(op & 7, this.roxr16, 5);
			break;
		case 0o513: // ROR.W #5,Dy
			this.rwop16(op & 7, this.ror16, 5);
			break;
		case 0o514: // ASR.W D5,Dy
			this.rwop16(op & 7, this.asr16, this.d5);
			break;
		case 0o515: // LSR.W D5,Dy
			this.rwop16(op & 7, this.lsr16, this.d5);
			break;
		case 0o516: // ROXR.W D5,Dy
			this.rwop16(op & 7, this.roxr16, this.d5);
			break;
		case 0o517: // ROR.W D5,Dy
			this.rwop16(op & 7, this.ror16, this.d5);
			break;
		case 0o520: // ASR.L #5,Dy
			this.rwop32(op & 7, this.asr32, 5);
			break;
		case 0o521: // LSR.L #5,Dy
			this.rwop32(op & 7, this.lsr32, 5);
			break;
		case 0o522: // ROXR.L #5,Dy
			this.rwop32(op & 7, this.roxr32, 5);
			break;
		case 0o523: // ROR.L #5,Dy
			this.rwop32(op & 7, this.ror32, 5);
			break;
		case 0o524: // ASR.L D5,Dy
			this.rwop32(op & 7, this.asr32, this.d5);
			break;
		case 0o525: // LSR.L D5,Dy
			this.rwop32(op & 7, this.lsr32, this.d5);
			break;
		case 0o526: // ROXR.L D5,Dy
			this.rwop32(op & 7, this.roxr32, this.d5);
			break;
		case 0o527: // ROR.L D5,Dy
			this.rwop32(op & 7, this.ror32, this.d5);
			break;
		case 0o540: // ASL.B #5,Dy
			this.rwop8(op & 7, this.asl8, 5);
			break;
		case 0o541: // LSL.B #5,Dy
			this.rwop8(op & 7, this.lsl8, 5);
			break;
		case 0o542: // ROXL.B #5,Dy
			this.rwop8(op & 7, this.roxl8, 5);
			break;
		case 0o543: // ROL.B #5,Dy
			this.rwop8(op & 7, this.rol8, 5);
			break;
		case 0o544: // ASL.B D5,Dy
			this.rwop8(op & 7, this.asl8, this.d5);
			break;
		case 0o545: // LSL.B D5,Dy
			this.rwop8(op & 7, this.lsl8, this.d5);
			break;
		case 0o546: // ROXL.B D5,Dy
			this.rwop8(op & 7, this.roxl8, this.d5);
			break;
		case 0o547: // ROL.B D5,Dy
			this.rwop8(op & 7, this.rol8, this.d5);
			break;
		case 0o550: // ASL.W #5,Dy
			this.rwop16(op & 7, this.asl16, 5);
			break;
		case 0o551: // LSL.W #5,Dy
			this.rwop16(op & 7, this.lsl16, 5);
			break;
		case 0o552: // ROXL.W #5,Dy
			this.rwop16(op & 7, this.roxl16, 5);
			break;
		case 0o553: // ROL.W #5,Dy
			this.rwop16(op & 7, this.rol16, 5);
			break;
		case 0o554: // ASL.W D5,Dy
			this.rwop16(op & 7, this.asl16, this.d5);
			break;
		case 0o555: // LSL.W D5,Dy
			this.rwop16(op & 7, this.lsl16, this.d5);
			break;
		case 0o556: // ROXL.W D5,Dy
			this.rwop16(op & 7, this.roxl16, this.d5);
			break;
		case 0o557: // ROL.W D5,Dy
			this.rwop16(op & 7, this.rol16, this.d5);
			break;
		case 0o560: // ASL.L #5,Dy
			this.rwop32(op & 7, this.asl32, 5);
			break;
		case 0o561: // LSL.L #5,Dy
			this.rwop32(op & 7, this.lsl32, 5);
			break;
		case 0o562: // ROXL.L #5,Dy
			this.rwop32(op & 7, this.roxl32, 5);
			break;
		case 0o563: // ROL.L #5,Dy
			this.rwop32(op & 7, this.rol32, 5);
			break;
		case 0o564: // ASL.L D5,Dy
			this.rwop32(op & 7, this.asl32, this.d5);
			break;
		case 0o565: // LSL.L D5,Dy
			this.rwop32(op & 7, this.lsl32, this.d5);
			break;
		case 0o566: // ROXL.L D5,Dy
			this.rwop32(op & 7, this.roxl32, this.d5);
			break;
		case 0o567: // ROL.L D5,Dy
			this.rwop32(op & 7, this.rol32, this.d5);
			break;
		case 0o600: // ASR.B #6,Dy
			this.rwop8(op & 7, this.asr8, 6);
			break;
		case 0o601: // LSR.B #6,Dy
			this.rwop8(op & 7, this.lsr8, 6);
			break;
		case 0o602: // ROXR.B #6,Dy
			this.rwop8(op & 7, this.roxr8, 6);
			break;
		case 0o603: // ROR.B #6,Dy
			this.rwop8(op & 7, this.ror8, 6);
			break;
		case 0o604: // ASR.B D6,Dy
			this.rwop8(op & 7, this.asr8, this.d6);
			break;
		case 0o605: // LSR.B D6,Dy
			this.rwop8(op & 7, this.lsr8, this.d6);
			break;
		case 0o606: // ROXR.B D6,Dy
			this.rwop8(op & 7, this.roxr8, this.d6);
			break;
		case 0o607: // ROR.B D6,Dy
			this.rwop8(op & 7, this.ror8, this.d6);
			break;
		case 0o610: // ASR.W #6,Dy
			this.rwop16(op & 7, this.asr16, 6);
			break;
		case 0o611: // LSR.W #6,Dy
			this.rwop16(op & 7, this.lsr16, 6);
			break;
		case 0o612: // ROXR.W #6,Dy
			this.rwop16(op & 7, this.roxr16, 6);
			break;
		case 0o613: // ROR.W #6,Dy
			this.rwop16(op & 7, this.ror16, 6);
			break;
		case 0o614: // ASR.W D6,Dy
			this.rwop16(op & 7, this.asr16, this.d6);
			break;
		case 0o615: // LSR.W D6,Dy
			this.rwop16(op & 7, this.lsr16, this.d6);
			break;
		case 0o616: // ROXR.W D6,Dy
			this.rwop16(op & 7, this.roxr16, this.d6);
			break;
		case 0o617: // ROR.W D6,Dy
			this.rwop16(op & 7, this.ror16, this.d6);
			break;
		case 0o620: // ASR.L #6,Dy
			this.rwop32(op & 7, this.asr32, 6);
			break;
		case 0o621: // LSR.L #6,Dy
			this.rwop32(op & 7, this.lsr32, 6);
			break;
		case 0o622: // ROXR.L #6,Dy
			this.rwop32(op & 7, this.roxr32, 6);
			break;
		case 0o623: // ROR.L #6,Dy
			this.rwop32(op & 7, this.ror32, 6);
			break;
		case 0o624: // ASR.L D6,Dy
			this.rwop32(op & 7, this.asr32, this.d6);
			break;
		case 0o625: // LSR.L D6,Dy
			this.rwop32(op & 7, this.lsr32, this.d6);
			break;
		case 0o626: // ROXR.L D6,Dy
			this.rwop32(op & 7, this.roxr32, this.d6);
			break;
		case 0o627: // ROR.L D6,Dy
			this.rwop32(op & 7, this.ror32, this.d6);
			break;
		case 0o640: // ASL.B #6,Dy
			this.rwop8(op & 7, this.asl8, 6);
			break;
		case 0o641: // LSL.B #6,Dy
			this.rwop8(op & 7, this.lsl8, 6);
			break;
		case 0o642: // ROXL.B #6,Dy
			this.rwop8(op & 7, this.roxl8, 6);
			break;
		case 0o643: // ROL.B #6,Dy
			this.rwop8(op & 7, this.rol8, 6);
			break;
		case 0o644: // ASL.B D6,Dy
			this.rwop8(op & 7, this.asl8, this.d6);
			break;
		case 0o645: // LSL.B D6,Dy
			this.rwop8(op & 7, this.lsl8, this.d6);
			break;
		case 0o646: // ROXL.B D6,Dy
			this.rwop8(op & 7, this.roxl8, this.d6);
			break;
		case 0o647: // ROL.B D6,Dy
			this.rwop8(op & 7, this.rol8, this.d6);
			break;
		case 0o650: // ASL.W #6,Dy
			this.rwop16(op & 7, this.asl16, 6);
			break;
		case 0o651: // LSL.W #6,Dy
			this.rwop16(op & 7, this.lsl16, 6);
			break;
		case 0o652: // ROXL.W #6,Dy
			this.rwop16(op & 7, this.roxl16, 6);
			break;
		case 0o653: // ROL.W #6,Dy
			this.rwop16(op & 7, this.rol16, 6);
			break;
		case 0o654: // ASL.W D6,Dy
			this.rwop16(op & 7, this.asl16, this.d6);
			break;
		case 0o655: // LSL.W D6,Dy
			this.rwop16(op & 7, this.lsl16, this.d6);
			break;
		case 0o656: // ROXL.W D6,Dy
			this.rwop16(op & 7, this.roxl16, this.d6);
			break;
		case 0o657: // ROL.W D6,Dy
			this.rwop16(op & 7, this.rol16, this.d6);
			break;
		case 0o660: // ASL.L #6,Dy
			this.rwop32(op & 7, this.asl32, 6);
			break;
		case 0o661: // LSL.L #6,Dy
			this.rwop32(op & 7, this.lsl32, 6);
			break;
		case 0o662: // ROXL.L #6,Dy
			this.rwop32(op & 7, this.roxl32, 6);
			break;
		case 0o663: // ROL.L #6,Dy
			this.rwop32(op & 7, this.rol32, 6);
			break;
		case 0o664: // ASL.L D6,Dy
			this.rwop32(op & 7, this.asl32, this.d6);
			break;
		case 0o665: // LSL.L D6,Dy
			this.rwop32(op & 7, this.lsl32, this.d6);
			break;
		case 0o666: // ROXL.L D6,Dy
			this.rwop32(op & 7, this.roxl32, this.d6);
			break;
		case 0o667: // ROL.L D6,Dy
			this.rwop32(op & 7, this.rol32, this.d6);
			break;
		case 0o700: // ASR.B #7,Dy
			this.rwop8(op & 7, this.asr8, 7);
			break;
		case 0o701: // LSR.B #7,Dy
			this.rwop8(op & 7, this.lsr8, 7);
			break;
		case 0o702: // ROXR.B #7,Dy
			this.rwop8(op & 7, this.roxr8, 7);
			break;
		case 0o703: // ROR.B #7,Dy
			this.rwop8(op & 7, this.ror8, 7);
			break;
		case 0o704: // ASR.B D7,Dy
			this.rwop8(op & 7, this.asr8, this.d7);
			break;
		case 0o705: // LSR.B D7,Dy
			this.rwop8(op & 7, this.lsr8, this.d7);
			break;
		case 0o706: // ROXR.B D7,Dy
			this.rwop8(op & 7, this.roxr8, this.d7);
			break;
		case 0o707: // ROR.B D7,Dy
			this.rwop8(op & 7, this.ror8, this.d7);
			break;
		case 0o710: // ASR.W #7,Dy
			this.rwop16(op & 7, this.asr16, 7);
			break;
		case 0o711: // LSR.W #7,Dy
			this.rwop16(op & 7, this.lsr16, 7);
			break;
		case 0o712: // ROXR.W #7,Dy
			this.rwop16(op & 7, this.roxr16, 7);
			break;
		case 0o713: // ROR.W #7,Dy
			this.rwop16(op & 7, this.ror16, 7);
			break;
		case 0o714: // ASR.W D7,Dy
			this.rwop16(op & 7, this.asr16, this.d7);
			break;
		case 0o715: // LSR.W D7,Dy
			this.rwop16(op & 7, this.lsr16, this.d7);
			break;
		case 0o716: // ROXR.W D7,Dy
			this.rwop16(op & 7, this.roxr16, this.d7);
			break;
		case 0o717: // ROR.W D7,Dy
			this.rwop16(op & 7, this.ror16, this.d7);
			break;
		case 0o720: // ASR.L #7,Dy
			this.rwop32(op & 7, this.asr32, 7);
			break;
		case 0o721: // LSR.L #7,Dy
			this.rwop32(op & 7, this.lsr32, 7);
			break;
		case 0o722: // ROXR.L #7,Dy
			this.rwop32(op & 7, this.roxr32, 7);
			break;
		case 0o723: // ROR.L #7,Dy
			this.rwop32(op & 7, this.ror32, 7);
			break;
		case 0o724: // ASR.L D7,Dy
			this.rwop32(op & 7, this.asr32, this.d7);
			break;
		case 0o725: // LSR.L D7,Dy
			this.rwop32(op & 7, this.lsr32, this.d7);
			break;
		case 0o726: // ROXR.L D7,Dy
			this.rwop32(op & 7, this.roxr32, this.d7);
			break;
		case 0o727: // ROR.L D7,Dy
			this.rwop32(op & 7, this.ror32, this.d7);
			break;
		case 0o740: // ASL.B #7,Dy
			this.rwop8(op & 7, this.asl8, 7);
			break;
		case 0o741: // LSL.B #7,Dy
			this.rwop8(op & 7, this.lsl8, 7);
			break;
		case 0o742: // ROXL.B #7,Dy
			this.rwop8(op & 7, this.roxl8, 7);
			break;
		case 0o743: // ROL.B #7,Dy
			this.rwop8(op & 7, this.rol8, 7);
			break;
		case 0o744: // ASL.B D7,Dy
			this.rwop8(op & 7, this.asl8, this.d7);
			break;
		case 0o745: // LSL.B D7,Dy
			this.rwop8(op & 7, this.lsl8, this.d7);
			break;
		case 0o746: // ROXL.B D7,Dy
			this.rwop8(op & 7, this.roxl8, this.d7);
			break;
		case 0o747: // ROL.B D7,Dy
			this.rwop8(op & 7, this.rol8, this.d7);
			break;
		case 0o750: // ASL.W #7,Dy
			this.rwop16(op & 7, this.asl16, 7);
			break;
		case 0o751: // LSL.W #7,Dy
			this.rwop16(op & 7, this.lsl16, 7);
			break;
		case 0o752: // ROXL.W #7,Dy
			this.rwop16(op & 7, this.roxl16, 7);
			break;
		case 0o753: // ROL.W #7,Dy
			this.rwop16(op & 7, this.rol16, 7);
			break;
		case 0o754: // ASL.W D7,Dy
			this.rwop16(op & 7, this.asl16, this.d7);
			break;
		case 0o755: // LSL.W D7,Dy
			this.rwop16(op & 7, this.lsl16, this.d7);
			break;
		case 0o756: // ROXL.W D7,Dy
			this.rwop16(op & 7, this.roxl16, this.d7);
			break;
		case 0o757: // ROL.W D7,Dy
			this.rwop16(op & 7, this.rol16, this.d7);
			break;
		case 0o760: // ASL.L #7,Dy
			this.rwop32(op & 7, this.asl32, 7);
			break;
		case 0o761: // LSL.L #7,Dy
			this.rwop32(op & 7, this.lsl32, 7);
			break;
		case 0o762: // ROXL.L #7,Dy
			this.rwop32(op & 7, this.roxl32, 7);
			break;
		case 0o763: // ROL.L #7,Dy
			this.rwop32(op & 7, this.rol32, 7);
			break;
		case 0o764: // ASL.L D7,Dy
			this.rwop32(op & 7, this.asl32, this.d7);
			break;
		case 0o765: // LSL.L D7,Dy
			this.rwop32(op & 7, this.lsl32, this.d7);
			break;
		case 0o766: // ROXL.L D7,Dy
			this.rwop32(op & 7, this.roxl32, this.d7);
			break;
		case 0o767: // ROL.L D7,Dy
			this.rwop32(op & 7, this.rol32, this.d7);
			break;
		default:
			return void this.exception(4);
		}
	...
	rwop8(op, fn, src) {
		...
		switch(op & 0o77) {
		case 0o00: // B D0
			this.d0 = this.d0 & ~0xff | fn.call(this, src, this.d0 & 0xff);
			break;
		case 0o01: // B D1
			this.d1 = this.d1 & ~0xff | fn.call(this, src, this.d1 & 0xff);
			break;
		case 0o02: // B D2
			this.d2 = this.d2 & ~0xff | fn.call(this, src, this.d2 & 0xff);
			break;
		case 0o03: // B D3
			this.d3 = this.d3 & ~0xff | fn.call(this, src, this.d3 & 0xff);
			break;
		case 0o04: // B D4
			this.d4 = this.d4 & ~0xff | fn.call(this, src, this.d4 & 0xff);
			break;
		case 0o05: // B D5
			this.d5 = this.d5 & ~0xff | fn.call(this, src, this.d5 & 0xff);
			break;
		case 0o06: // B D6
			this.d6 = this.d6 & ~0xff | fn.call(this, src, this.d6 & 0xff);
			break;
		case 0o07: // B D7
			this.d7 = this.d7 & ~0xff | fn.call(this, src, this.d7 & 0xff);
			break;
		case 0o20: // B (A0)
		...
		case 0o37: // B (A7)+
			...
			break;
		case 0o40: // B -(A0)
			this.write8(fn.call(this, src, this.read8(this.a0 = this.a0 - 1 | 0)), this.a0);
			break;
		case 0o41: // B -(A1)
			this.write8(fn.call(this, src, this.read8(this.a1 = this.a1 - 1 | 0)), this.a1);
			break;
		case 0o42: // B -(A2)
			this.write8(fn.call(this, src, this.read8(this.a2 = this.a2 - 1 | 0)), this.a2);
			break;
		case 0o43: // B -(A3)
			this.write8(fn.call(this, src, this.read8(this.a3 = this.a3 - 1 | 0)), this.a3);
			break;
		case 0o44: // B -(A4)
			this.write8(fn.call(this, src, this.read8(this.a4 = this.a4 - 1 | 0)), this.a4);
			break;
		case 0o45: // B -(A5)
			this.write8(fn.call(this, src, this.read8(this.a5 = this.a5 - 1 | 0)), this.a5);
			break;
		case 0o46: // B -(A6)
			this.write8(fn.call(this, src, this.read8(this.a6 = this.a6 - 1 | 0)), this.a6);
			break;
		case 0o47: // B -(A7)
			this.write8(fn.call(this, src, this.read8(this.a7 = this.a7 - 1 | 0)), this.a7);
			break;
		case 0o50: // B d(A0)
			this.write8(fn.call(this, src, this.read8(ea = this.a0 + this.fetch16s() | 0)), ea);
			break;
		case 0o51: // B d(A1)
			this.write8(fn.call(this, src, this.read8(ea = this.a1 + this.fetch16s() | 0)), ea);
			break;
		case 0o52: // B d(A2)
			this.write8(fn.call(this, src, this.read8(ea = this.a2 + this.fetch16s() | 0)), ea);
			break;
		case 0o53: // B d(A3)
			this.write8(fn.call(this, src, this.read8(ea = this.a3 + this.fetch16s() | 0)), ea);
			break;
		case 0o54: // B d(A4)
			this.write8(fn.call(this, src, this.read8(ea = this.a4 + this.fetch16s() | 0)), ea);
			break;
		case 0o55: // B d(A5)
			this.write8(fn.call(this, src, this.read8(ea = this.a5 + this.fetch16s() | 0)), ea);
			break;
		case 0o56: // B d(A6)
			this.write8(fn.call(this, src, this.read8(ea = this.a6 + this.fetch16s() | 0)), ea);
			break;
		case 0o57: // B d(A7)
			this.write8(fn.call(this, src, this.read8(ea = this.a7 + this.fetch16s() | 0)), ea);
			break;
		case 0o60: // B d(A0,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a0))), ea);
			break;
		case 0o61: // B d(A1,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a1))), ea);
			break;
		case 0o62: // B d(A2,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a2))), ea);
			break;
		case 0o63: // B d(A3,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a3))), ea);
			break;
		case 0o64: // B d(A4,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a4))), ea);
			break;
		case 0o65: // B d(A5,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a5))), ea);
			break;
		case 0o66: // B d(A6,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a6))), ea);
			break;
		case 0o67: // B d(A7,Xi)
			this.write8(fn.call(this, src, this.read8(ea = this.index(this.a7))), ea);
			break;
		case 0o70: // B Abs.W
			this.write8(fn.call(this, src, this.read8(ea = this.fetch16s())), ea);
			break;
		case 0o71: // B Abs.L
			this.write8(fn.call(this, src, this.read8(ea = this.fetch32())), ea);
			break;
		}
	}
	...
	rwop16(op, fn, src) {
		...
		switch(op & 0o77) {
		case 0o00: // W D0
			this.d0 = this.d0 & ~0xffff | fn.call(this, src, this.d0 & 0xffff);
			break;
		case 0o01: // W D1
			this.d1 = this.d1 & ~0xffff | fn.call(this, src, this.d1 & 0xffff);
			break;
		case 0o02: // W D2
			this.d2 = this.d2 & ~0xffff | fn.call(this, src, this.d2 & 0xffff);
			break;
		case 0o03: // W D3
			this.d3 = this.d3 & ~0xffff | fn.call(this, src, this.d3 & 0xffff);
			break;
		case 0o04: // W D4
			this.d4 = this.d4 & ~0xffff | fn.call(this, src, this.d4 & 0xffff);
			break;
		case 0o05: // W D5
			this.d5 = this.d5 & ~0xffff | fn.call(this, src, this.d5 & 0xffff);
			break;
		case 0o06: // W D6
			this.d6 = this.d6 & ~0xffff | fn.call(this, src, this.d6 & 0xffff);
			break;
		case 0o07: // W D7
			this.d7 = this.d7 & ~0xffff | fn.call(this, src, this.d7 & 0xffff);
			break;
		case 0o10: // W A0
			this.a0 = fn.call(this, src, this.a0);
			break;
		case 0o11: // W A1
			this.a1 = fn.call(this, src, this.a1);
			break;
		case 0o12: // W A2
			this.a2 = fn.call(this, src, this.a2);
			break;
		case 0o13: // W A3
			this.a3 = fn.call(this, src, this.a3);
			break;
		case 0o14: // W A4
			this.a4 = fn.call(this, src, this.a4);
			break;
		case 0o15: // W A5
			this.a5 = fn.call(this, src, this.a5);
			break;
		case 0o16: // W A6
			this.a6 = fn.call(this, src, this.a6);
			break;
		case 0o17: // W A7
			this.a7 = fn.call(this, src, this.a7);
			break;
		case 0o20: // W (A0)
		...
		case 0o37: // W (A7)+
			...
			break;
		case 0o40: // W -(A0)
			this.write16(fn.call(this, src, this.read16(this.a0 = this.a0 - 2 | 0)), this.a0);
			break;
		case 0o41: // W -(A1)
			this.write16(fn.call(this, src, this.read16(this.a1 = this.a1 - 2 | 0)), this.a1);
			break;
		case 0o42: // W -(A2)
			this.write16(fn.call(this, src, this.read16(this.a2 = this.a2 - 2 | 0)), this.a2);
			break;
		case 0o43: // W -(A3)
			this.write16(fn.call(this, src, this.read16(this.a3 = this.a3 - 2 | 0)), this.a3);
			break;
		case 0o44: // W -(A4)
			this.write16(fn.call(this, src, this.read16(this.a4 = this.a4 - 2 | 0)), this.a4);
			break;
		case 0o45: // W -(A5)
			this.write16(fn.call(this, src, this.read16(this.a5 = this.a5 - 2 | 0)), this.a5);
			break;
		case 0o46: // W -(A6)
			this.write16(fn.call(this, src, this.read16(this.a6 = this.a6 - 2 | 0)), this.a6);
			break;
		case 0o47: // W -(A7)
			this.write16(fn.call(this, src, this.read16(this.a7 = this.a7 - 2 | 0)), this.a7);
			break;
		case 0o50: // W d(A0)
			this.write16(fn.call(this, src, this.read16(ea = this.a0 + this.fetch16s() | 0)), ea);
			break;
		case 0o51: // W d(A1)
			this.write16(fn.call(this, src, this.read16(ea = this.a1 + this.fetch16s() | 0)), ea);
			break;
		case 0o52: // W d(A2)
			this.write16(fn.call(this, src, this.read16(ea = this.a2 + this.fetch16s() | 0)), ea);
			break;
		case 0o53: // W d(A3)
			this.write16(fn.call(this, src, this.read16(ea = this.a3 + this.fetch16s() | 0)), ea);
			break;
		case 0o54: // W d(A4)
			this.write16(fn.call(this, src, this.read16(ea = this.a4 + this.fetch16s() | 0)), ea);
			break;
		case 0o55: // W d(A5)
			this.write16(fn.call(this, src, this.read16(ea = this.a5 + this.fetch16s() | 0)), ea);
			break;
		case 0o56: // W d(A6)
			this.write16(fn.call(this, src, this.read16(ea = this.a6 + this.fetch16s() | 0)), ea);
			break;
		case 0o57: // W d(A7)
			this.write16(fn.call(this, src, this.read16(ea = this.a7 + this.fetch16s() | 0)), ea);
			break;
		case 0o60: // W d(A0,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a0))), ea);
			break;
		case 0o61: // W d(A1,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a1))), ea);
			break;
		case 0o62: // W d(A2,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a2))), ea);
			break;
		case 0o63: // W d(A3,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a3))), ea);
			break;
		case 0o64: // W d(A4,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a4))), ea);
			break;
		case 0o65: // W d(A5,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a5))), ea);
			break;
		case 0o66: // W d(A6,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a6))), ea);
			break;
		case 0o67: // W d(A7,Xi)
			this.write16(fn.call(this, src, this.read16(ea = this.index(this.a7))), ea);
			break;
		case 0o70: // W Abs.W
			this.write16(fn.call(this, src, this.read16(ea = this.fetch16s())), ea);
			break;
		case 0o71: // W Abs.L
			this.write16(fn.call(this, src, this.read16(ea = this.fetch32())), ea);
			break;
		}
	}
	...
	rwop32(op, fn, src) {
		...
		switch(op & 0o77) {
		case 0o00: // L D0
			this.d0 = fn.call(this, src, this.d0);
			break;
		case 0o01: // L D1
			this.d1 = fn.call(this, src, this.d1);
			break;
		case 0o02: // L D2
			this.d2 = fn.call(this, src, this.d2);
			break;
		case 0o03: // L D3
			this.d3 = fn.call(this, src, this.d3);
			break;
		case 0o04: // L D4
			this.d4 = fn.call(this, src, this.d4);
			break;
		case 0o05: // L D5
			this.d5 = fn.call(this, src, this.d5);
			break;
		case 0o06: // L D6
			this.d6 = fn.call(this, src, this.d6);
			break;
		case 0o07: // L D7
			this.d7 = fn.call(this, src, this.d7);
			break;
		case 0o10: // L A0
			this.a0 = fn.call(this, src, this.a0);
			break;
		...
		case 0o37: // L (A7)+
			...
			break;
		case 0o40: // L -(A0)
			this.write32(fn.call(this, src, this.read32(this.a0 = this.a0 - 4 | 0)), this.a0);
			break;
		case 0o41: // L -(A1)
			this.write32(fn.call(this, src, this.read32(this.a1 = this.a1 - 4 | 0)), this.a1);
			break;
		case 0o42: // L -(A2)
			this.write32(fn.call(this, src, this.read32(this.a2 = this.a2 - 4 | 0)), this.a2);
			break;
		case 0o43: // L -(A3)
			this.write32(fn.call(this, src, this.read32(this.a3 = this.a3 - 4 | 0)), this.a3);
			break;
		case 0o44: // L -(A4)
			this.write32(fn.call(this, src, this.read32(this.a4 = this.a4 - 4 | 0)), this.a4);
			break;
		case 0o45: // L -(A5)
			this.write32(fn.call(this, src, this.read32(this.a5 = this.a5 - 4 | 0)), this.a5);
			break;
		case 0o46: // L -(A6)
			this.write32(fn.call(this, src, this.read32(this.a6 = this.a6 - 4 | 0)), this.a6);
			break;
		case 0o47: // L -(A7)
			this.write32(fn.call(this, src, this.read32(this.a7 = this.a7 - 4 | 0)), this.a7);
			break;
		case 0o50: // L d(A0)
			this.write32(fn.call(this, src, this.read32(ea = this.a0 + this.fetch16s() | 0)), ea);
			break;
		case 0o51: // L d(A1)
			this.write32(fn.call(this, src, this.read32(ea = this.a1 + this.fetch16s() | 0)), ea);
			break;
		case 0o52: // L d(A2)
			this.write32(fn.call(this, src, this.read32(ea = this.a2 + this.fetch16s() | 0)), ea);
			break;
		case 0o53: // L d(A3)
			this.write32(fn.call(this, src, this.read32(ea = this.a3 + this.fetch16s() | 0)), ea);
			break;
		case 0o54: // L d(A4)
			this.write32(fn.call(this, src, this.read32(ea = this.a4 + this.fetch16s() | 0)), ea);
			break;
		case 0o55: // L d(A5)
			this.write32(fn.call(this, src, this.read32(ea = this.a5 + this.fetch16s() | 0)), ea);
			break;
		case 0o56: // L d(A6)
			this.write32(fn.call(this, src, this.read32(ea = this.a6 + this.fetch16s() | 0)), ea);
			break;
		case 0o57: // L d(A7)
			this.write32(fn.call(this, src, this.read32(ea = this.a7 + this.fetch16s() | 0)), ea);
			break;
		case 0o60: // L d(A0,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a0))), ea);
			break;
		case 0o61: // L d(A1,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a1))), ea);
			break;
		case 0o62: // L d(A2,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a2))), ea);
			break;
		case 0o63: // L d(A3,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a3))), ea);
			break;
		case 0o64: // L d(A4,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a4))), ea);
			break;
		case 0o65: // L d(A5,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a5))), ea);
			break;
		case 0o66: // L d(A6,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a6))), ea);
			break;
		case 0o67: // L d(A7,Xi)
			this.write32(fn.call(this, src, this.read32(ea = this.index(this.a7))), ea);
			break;
		case 0o70: // L Abs.W
			this.write32(fn.call(this, src, this.read32(ea = this.fetch16s())), ea);
			break;
		case 0o71: // L Abs.L
			this.write32(fn.call(this, src, this.read32(ea = this.fetch32())), ea);
			break;
		}
	}
	...
	sub8(src, dst) {
		const result = dst - src | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result & 0xff;
		this.sr = this.sr & ~0x1f | c >>> 3 & 0x10 | dst >>> 4 & 8 | !dst << 2 | v >>> 6 & 2 | c >>> 7 & 1;
		return dst;
	}
	...
	sub16(src, dst) {
		const result = dst - src | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result & 0xffff;
		this.sr = this.sr & ~0x1f | c >>> 11 & 0x10 | dst >>> 12 & 8 | !dst << 2 | v >>> 14 & 2 | c >>> 15 & 1;
		return dst;
	}
	...
	sub32(src, dst) {
		const result = dst - src | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result;
		this.sr = this.sr & ~0x1f | c >>> 27 & 0x10 | dst >>> 28 & 8 | !dst << 2 | v >>> 30 & 2 | c >>> 31;
		return dst;
	}
	...
	cmp8(src, dst) {
		const result = dst - src | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result & 0xff;
		this.sr = this.sr & ~0x0f | dst >>> 4 & 8 | !dst << 2 | v >>> 6 & 2 | c >>> 7 & 1;
	}

	cmp16(src, dst) {
		const result = dst - src | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result & 0xffff;
		this.sr = this.sr & ~0x0f | dst >>> 12 & 8 | !dst << 2 | v >>> 14 & 2 | c >>> 15 & 1;
	}

	cmp32(src, dst) {
		const result = dst - src | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result;
		this.sr = this.sr & ~0x0f | dst >>> 28 & 8 | !dst << 2 | v >>> 30 & 2 | c >>> 31;
	}
	...
	divu(src, dst) {
		...
		const result = (dst >>> 0) / src | 0;
		if (result > 0xffff || result < 0) {
			this.sr |= 2;
			return dst;
		}
		dst = result | ((dst >>> 0) % src) << 16;
		this.sr = this.sr & ~0x0f | dst >>> 12 & 8 | !dst << 2;
		return dst;
	}

	sbcd(src, dst) {
		let result = dst - src - (this.sr >>> 4 & 0x10) & 0xff, c = ~dst & src | src & result | result & ~dst;
		if ((c & 8) !== 0 && (result & 0x0f) > 5 || (result & 0x0f) > 9)
			result -= 6;
		if ((c & 0x80) !== 0 && (result & 0xf0) > 0x50 || (result & 0xf0) > 0x90) {
			result -= 0x60;
			c |= 0x80;
		}
		dst = result & 0xff;
		this.sr = this.sr & ~0x15 | c >>> 3 & 0x10 | !dst << 2 | c >>> 7 & 1;
		return dst;
	}
	...
	divs(src, dst) {
		...
		dst = result & 0xffff | (dst % src) << 16;
		this.sr = this.sr & ~0x0f | dst >>> 12 & 8 | !dst << 2;
		return dst;
	}

	subx8(src, dst) {
		const result = dst - src - (this.sr >>> 4 & 0x10) | 0, v = dst & ~src & ~result | ~dst & src & result, c = ~dst & src | src & result | result & ~dst;
		dst = result & 0xff;
		this.sr = this.sr & ~0x1f | c >>> 3 & 0x10 | dst >>> 4 & 8 | !dst << 2 | v >>> 6 & 2 | c >>> 7 & 1;
		return dst;
	}
	...
	abcd(src, dst) {
		let result = dst + src + (this.sr >>> 4 & 0x10) & 0xff, c = dst & src | src & ~result | ~result & dst;
		if ((c & 8) !== 0 && (result & 0x0f) < 4 || (result & 0x0f) > 9)
			if ((result += 6) >= 0x100)
				c |= 0x80;
		if ((c & 0x80) !== 0 && (result & 0xf0) < 0x40 || (result & 0xf0) > 0x90) {
			result += 0x60;
			c |= 0x80;
		}
		dst = result & 0xff;
	...
	muls(src, dst) {
		dst = (dst - (dst << 1 & 0x10000)) * (src - (src << 1 & 0x10000)) | 0;
		this.sr = this.sr & ~0x0f | dst >>> 28 & 8 | !dst << 2;
		return dst;
	}
	...
	asr8(src, dst) {
		...
		src &= 63;
		dst -= dst << 1 & 0x100;
		x = src ? dst >> (src - 1) & 1 : this.sr >>> 4 & 1;
		c = src ? dst >> (src - 1) & 1 : 0;
		dst = dst >> src & 0xff;
		this.sr = this.sr & ~0x1f | x << 4 | dst >>> 4 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	asr16(src, dst) {
		...
		c = src ? dst >> (src - 1) & 1 : 0;
		dst = dst >> src & 0xffff;
		this.sr = this.sr & ~0x1f | x << 4 | dst >>> 12 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	asr32(src, dst) {
		...
		c = src ? dst >> (src - 1) & 1 : 0;
		dst >>= src;
		this.sr = this.sr & ~0x1f | x << 4 | dst >>> 28 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	ror8(src, dst) {
		src &= 63;
		const c = src ? dst >>> (src - 1 & 7) & 1 : 0;
		dst = dst >>> (src & 7) | dst << (7 - src & 7) + 1 & 0xff;
		this.sr = this.sr & ~0x0f | dst >>> 4 & 8 | !dst << 2 | c;
		return dst;
	}

	ror16(src, dst) {
		src &= 63;
		const c = src ? dst >>> (src - 1 & 15) & 1 : 0;
		dst = dst >>> (src & 15) | dst << (15 - src & 15) + 1 & 0xffff;
		this.sr = this.sr & ~0x0f | dst >>> 12 & 8 | !dst << 2 | c;
		return dst;
	}

	ror32(src, dst) {
		src &= 63;
		const c = src ? dst >>> (src - 1 & 31) & 1 : 0;
		dst = dst >>> (src & 31) | dst << (31 - src & 31) + 1;
	...
	lsl8(src, dst) {
		let x, c;
		src &= 63;
		x = src ? dst << (src - 1) >>> 7 & 1 : this.sr >>> 4 & 1;
		c = src ? dst << (src - 1) >>> 7 & 1 : 0;
		dst = dst << src & 0xff;
		this.sr = this.sr & ~0x1f | x << 4 | dst >>> 4 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	lsl16(src, dst) {
		let x, c;
		src &= 63;
		x = src ? dst << (src - 1) >>> 15 & 1 : this.sr >>> 4 & 1;
		c = src ? dst << (src - 1) >>> 15 & 1 : 0;
		dst = dst << src & 0xffff;
		this.sr = this.sr & ~0x1f | x << 4 | dst >>> 12 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	lsl32(src, dst) {
		let x, c;
		src &= 63;
		x = src ? dst << (src - 1) >>> 31 & 1 : this.sr >>> 4 & 1;
		c = src ? dst << (src - 1) >>> 31 & 1 : 0;
		dst <<= src;
		this.sr = this.sr & ~0x1f | x << 4 | dst >>> 28 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	rol8(src, dst) {
		src &= 63;
		const c = src ? dst >>> (-src & 7) & 1 : 0;
		dst = dst >>> (7 - src & 7) + 1 | dst << (src & 7) & 0xff;
		this.sr = this.sr & ~0x0f | dst >>> 4 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	rol16(src, dst) {
		src &= 63;
		const c = src ? dst >>> (-src & 15) & 1 : 0;
		dst = dst >>> (15 - src & 15) + 1 | dst << (src & 15) & 0xffff;
		this.sr = this.sr & ~0x0f | dst >>> 12 & 8 | !dst << 2 | c;
		return dst;
	}
	...
	negx8(src, dst) {
		const result = 0 - dst - (this.sr >>> 4 & 1) | 0, v = dst & result, c = dst | result;
		dst = result & 0xff;
		this.sr = this.sr & ~0x1f | c >>> 3 & 0x10 | dst >>> 4 & 8 | !dst << 2 | v >>> 6 & 2 | c >>> 7 & 1;
		return dst;
	}
	...
	neg8(src, dst) {
		const result = 0 - dst | 0, v = dst & result, c = dst | result;
		dst = result & 0xff;
		this.sr = this.sr & ~0x1f | c >>> 3 & 0x10 | dst >>> 4 & 8 | !dst << 2 | v >>> 6 & 2 | c >>> 7 & 1;
		return dst;
	}
	...
	nbcd(src, dst) {
		let result = 0 - dst - (this.sr >>> 4 & 0x10) & 0xff, c = dst | result;
		if ((c & 8) !== 0 && (result & 0x0f) > 5 || (result & 0x0f) > 9)
			result -= 6;
		if ((c & 0x80) !== 0 && (result & 0xf0) > 0x50 || (result & 0xf0) > 0x90) {
			result -= 0x60;
	...
	ext16(src, dst) {
		dst = (dst & 0xff) - (dst << 1 & 0x100) & 0xffff;
		this.sr = this.sr & ~0x0f | dst >>> 12 & 8 | !dst << 2;
		return dst;
	}
