...
export default class MC68000 extends Cpu {
	...
	execute_1(op) {
		...
		case 0o037: // MOVE.B Abs...,(A0)+
			if ((op & 7) >= 5)
				return this.exception(4);
			return src = this.rop8(op, true), this.write8(src, this.a0), void(this.a1 = this.a1 + 1 | 0);
		...
		case 0o736: // MOVE.B d(An,Xi),(A7)+
			return src = this.rop8(op, true), this.write8(src, this.a7), void(this.a7 = this.a7 + 1 | 0);
		...
		case 0o746: // MOVE.B d(An,Xi),-(A7)
			return src = this.rop8(op, true), this.a7 = this.a7 - 1 | 0, this.write8(src, this.a7);
	...
	execute_4(op) {
		...
		case 0o715: // MOVE USP,An
			if ((this.sr & 0x2000) === 0)
				return this.exception(8);
			return this.rwop32(op & 7 | 0o10, this.thru, this.usp);
		case 0o716:
			switch(op & 7) {
			case 0: // RESET
				if ((this.sr & 0x2000) === 0)
			...
			case 3: // RTE
				if ((this.sr & 0x2000) === 0)
					return this.exception(8);
				this.sr = this.read16(this.a7), this.a7 = this.a7 + 2 | 0, this.pc = this.read32(this.a7), this.a7 = this.a7 + 4 | 0;
				if ((this.sr & 0x2000) === 0)
					this.ssp = this.a7, this.a7 = this.usp;
				return;
			case 4: // RTD 68010
	...
	execute_5(op) {
		...
		case 0o127: // ADDQ.L #1,Abs...
			...
			return this.rwop32(op, this.add32, 1);
		case 0o130: // SHI Dn
			return this.rwop8(op, this.thru, ((this.sr >> 2 | this.sr) & 1) === 0 ? 0xff : 0);
		...
		case 0o227: // ADDQ.L #2,Abs...
			...
			return this.rwop32(op, this.add32, 2);
		case 0o230: // SCC Dn
			return this.rwop8(op, this.thru, (this.sr & 1) === 0 ? 0xff : 0);
		...
		case 0o327: // ADDQ.L #3,Abs...
			...
			return this.rwop32(op, this.add32, 3);
		case 0o330: // SNE Dn
			return this.rwop8(op, this.thru, (this.sr & 4) === 0 ? 0xff : 0);
		...
		case 0o427: // ADDQ.L #4,Abs...
			...
			return this.rwop32(op, this.add32, 4);
		case 0o430: // SVC Dn
			return this.rwop8(op, this.thru, (this.sr & 2) === 0 ? 0xff : 0);
		...
		case 0o527: // ADDQ.L #5,Abs...
			...
			return this.rwop32(op, this.add32, 5);
		case 0o530: // SPL Dn
			return this.rwop8(op, this.thru, (this.sr & 8) === 0 ? 0xff : 0);
		...
		case 0o627: // ADDQ.L #6,Abs...
			...
			return this.rwop32(op, this.add32, 6);
		case 0o630: // SGE Dn
			return this.rwop8(op, this.thru, ((this.sr >> 2 ^ this.sr) & 2) === 0 ? 0xff : 0);
		...
		case 0o727: // ADDQ.L #7,Abs...
			...
			return this.rwop32(op, this.add32, 7);
		case 0o730: // SGT Dn
			return this.rwop8(op, this.thru, ((this.sr >> 2 ^ this.sr | this.sr >> 1) & 2) === 0 ? 0xff : 0);
	...
	execute_6(op) {
		...
		case 0x2: // BHI <label>
			return void(((this.sr >> 2 | this.sr) & 1) === 0 && (this.pc = addr));
		case 0x3: // BLS <label>
			return void(((this.sr >> 2 | this.sr) & 1) !== 0 && (this.pc = addr));
		case 0x4: // BCC <label>
			return void((this.sr & 1) === 0 && (this.pc = addr));
		case 0x5: // BCS <label>
			return void((this.sr & 1) !== 0 && (this.pc = addr));
		case 0x6: // BNE <label>
			return void((this.sr & 4) === 0 && (this.pc = addr));
		case 0x7: // BEQ <label>
			return void((this.sr & 4) !== 0 && (this.pc = addr));
		case 0x8: // BVC <label>
			return void((this.sr & 2) === 0 && (this.pc = addr));
		case 0x9: // BVS <label>
			return void((this.sr & 2) !== 0 && (this.pc = addr));
		case 0xa: // BPL <label>
			return void((this.sr & 8) === 0 && (this.pc = addr));
		case 0xb: // BMI <label>
			return void((this.sr & 8) !== 0 && (this.pc = addr));
		case 0xc: // BGE <label>
			return void(((this.sr >> 2 ^ this.sr) & 2) === 0 && (this.pc = addr));
		case 0xd: // BLT <label>
			return void(((this.sr >> 2 ^ this.sr) & 2) !== 0 && (this.pc = addr));
		case 0xe: // BGT <label>
			return void(((this.sr >> 2 ^ this.sr | this.sr >> 1) & 2) === 0 && (this.pc = addr));
		case 0xf: // BLE <label>
			return void(((this.sr >> 2 ^ this.sr | this.sr >> 1) & 2) !== 0 && (this.pc = addr));
		}
	}
	...
	execute_8(op) {
		...
		case 0o741: // SBCD -(Ay),-(A7)
			return src = this.rop8(op & 7 | 0o40), this.a7 = this.a7 - 1 | 0, this.write8(this.sbcd(src, this.read8(this.a7)), this.a7);
	...
	execute_9(op) {
		...
		case 0o741: // SUBX.B -(Ay),-(A7)
			return src = this.rop8(op & 7 | 0o40), this.a7 = this.a7 - 1 | 0, this.write8(this.subx8(src, this.read8(this.a7)), this.a7);
	...
	execute_b(op) {
		...
		case 0o741: // CMPM.B (Ay)+,(A7)+
			return src = this.rop8(op & 7 | 0o30), this.cmp8(src, this.read8(this.a7)), void(this.a7 = this.a7 + 1 | 0);
	...
	execute_c(op) {
		...
		case 0o741: // ABCD -(Ay),-(A7)
			return src = this.rop8(op & 7 | 0o40), this.a7 = this.a7 - 1 | 0, this.write8(this.abcd(src, this.read8(this.a7)), this.a7);
	...
	execute_d(op) {
		...
		case 0o741: // ADDX.B -(Ay),-(A7)
			return src = this.rop8(op & 7 | 0o40), this.a7 = this.a7 - 1 | 0, this.write8(this.addx8(src, this.read8(this.a7)), this.a7);
	...
	rwop8(op, fn, src) {
		...
		case 0o37: // B (A7)+
			return this.write8(fn.call(this, src, this.read8(this.a7)), this.a7), void(this.a7 = this.a7 + 1 | 0);
		case 0o40: // B -(A0)
		...
		case 0o47: // B -(A7)
			return this.a7 = this.a7 - 1 | 0, this.write8(fn.call(this, src, this.read8(this.a7)), this.a7);
		case 0o50: // B d(A0)
	...
	rop8(op, flag) {
		...
		case 0o36: // B (A6)+
			...
			break;
		case 0o37: // B (A7)+
			data = this.read8(this.a7), this.a7 = this.a7 + 1 | 0;
			break;
		case 0o40: // B -(A0)
		...
		case 0o46: // B -(A6)
			...
			break;
		case 0o47: // B -(A7)
			this.a7 = this.a7 - 1 | 0, data = this.read8(this.a7);
			break;
		case 0o50: // B d(A0)
		...
		case 0o71: // B Abs.L
			...
			break;
		case 0o72: // B d(PC)
			data = this.read8(this.disp(this.pc));
			break;
		case 0o73: // B d(PC,Xi)
	...
	rop16(op, flag) {
		...
		case 0o71: // W Abs.L
			...
			break;
		case 0o72: // W d(PC)
			data = this.read16(this.disp(this.pc));
			break;
		case 0o73: // W d(PC,Xi)
	...
	rop32(op, flag) {
		...
		case 0o71: // L Abs.L
			...
			break;
		case 0o72: // L d(PC)
			data = this.read32(this.disp(this.pc));
			break;
		case 0o73: // L d(PC,Xi)
	...
	chk(src, dst) {
		...
		if (dst >= 0 && dst <= src)
			return;
		this.sr = this.sr & ~8 | dst >> 12 & 8, this.exception(6);
	}
	...
	divu(src, dst) {
		...
		const r = (dst >>> 0) / src | 0;
		if (r > 0xffff || r < 0)
			return this.sr |= 2, dst;
		return this.sr = this.sr & ~0x0f | r >> 12 & 8 | !r << 2, r | (dst >>> 0) % src << 16;
	}
	...
	sbcd(src, dst) {
		...
		if ((c & 0x80) !== 0 && (r & 0xf0) > 0x50 || (r & 0xf0) > 0x90)
			r -= 0x60, c |= 0x80;
		return r &= 0xff, this.sr = this.sr & ~0x15 | c >> 3 & 0x10 | !r << 2 | c >> 7 & 1, r;
	}
	...
	divs(src, dst) {
		...
		if (r > 0x7fff || r < -0x8000)
			return this.sr |= 2, dst;
		return this.sr = this.sr & ~0x0f | r >> 12 & 8 | !r << 2, r & 0xffff | dst % src << 16;
	}
	...
	asl8(src, dst) {
		...
		return this.sr = this.sr & ~0x1f | x << 4 | dst >> 4 & 8 | !dst << 2 | v << 1 | c, dst;
	}
	...
	asl16(src, dst) {
		...
		return this.sr = this.sr & ~0x1f | x << 4 | dst >> 12 & 8 | !dst << 2 | v << 1 | c, dst;
	}
	...
	asl32(src, dst) {
		...
		src &= 63;
		for (let i = 0; i < src; i++)
			v |= (dst >> 31 ^ dst >> 30) & 1, x = dst >>> 31, c = dst >>> 31, dst = dst << 1;
		return this.sr = this.sr & ~0x1f | x << 4 | dst >> 28 & 8 | !dst << 2 | v << 1 | c, dst;
	}

	lsl8(src, dst) {
		const r = dst << (src &= 63) & 0xff, x = src ? dst << (src - 1) >> 7 & 1 : this.sr >> 4 & 1, c = src ? dst << (src - 1) >> 7 & 1 : 0;
		return this.sr = this.sr & ~0x1f | x << 4 | r >> 4 & 8 | !r << 2 | c, r;
	}

	lsl16(src, dst) {
		const r = dst << (src &= 63) & 0xffff, x = src ? dst << (src - 1) >> 15 & 1 : this.sr >> 4 & 1, c = src ? dst << (src - 1) >> 15 & 1 : 0;
		return this.sr = this.sr & ~0x1f | x << 4 | r >> 12 & 8 | !r << 2 | c, r;
	}

	lsl32(src, dst) {
		const r = dst << (src &= 63), x = src ? dst << (src - 1) >> 31 & 1 : this.sr >> 4 & 1, c = src ? dst << (src - 1) >> 31 & 1 : 0;
		return this.sr = this.sr & ~0x1f | x << 4 | r >> 28 & 8 | !r << 2 | c, r;
	}
	...
	fetch16s() {
		const page = this.memorymap[this.pc >> 8 & 0xffff];
		const data = page.base[this.pc & 0xff] << 8 | page.base[this.pc + 1 & 0xff];
		return this.pc = this.pc + 2 | 0, data << 16 >> 16;
	}

	fetch32() {
		const data = this.fetch16() << 16;
		return data | this.fetch16();
	}
