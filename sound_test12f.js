...
read('rompers.zip').then(buffer => new Zlib.Unzip(new Uint8Array(buffer))).then(zip => {
	SND = zip.decompress('rp1_snd0.bin').addBase();
	MCU = zip.decompress('cus64-64a1.mcu').addBase();
	VOI = zip.decompress('rp_voi-0.bin').addBase();
