...
export default class MC6805 extends Cpu {
	...
	_execute() {
		...
		switch (this.fetch()) {
		case 0x00: // BRSET0
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) & 1) & 1) !== 0);
		case 0x01: // BRCLR0
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) & 1) & 1) === 0);
		case 0x02: // BRSET1
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 1 & 1) & 1) !== 0);
		case 0x03: // BRCLR1
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 1 & 1) & 1) === 0);
		case 0x04: // BRSET2
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 2 & 1) & 1) !== 0);
		case 0x05: // BRCLR2
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 2 & 1) & 1) === 0);
		case 0x06: // BRSET3
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 3 & 1) & 1) !== 0);
		case 0x07: // BRCLR3
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 3 & 1) & 1) === 0);
		case 0x08: // BRSET4
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 4 & 1) & 1) !== 0);
		case 0x09: // BRCLR4
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 4 & 1) & 1) === 0);
		case 0x0a: // BRSET5
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 5 & 1) & 1) !== 0);
		case 0x0b: // BRCLR5
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 5 & 1) & 1) === 0);
		case 0x0c: // BRSET6
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 6 & 1) & 1) !== 0);
		case 0x0d: // BRCLR6
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 6 & 1) & 1) === 0);
		case 0x0e: // BRSET7
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 7 & 1) & 1) !== 0);
		case 0x0f: // BRCLR7
			return this.bcc(((this.ccr = this.ccr & ~1 | this.read(this.direct()) >>> 7 & 1) & 1) === 0);
		case 0x10: // BSET0
			return this.write(v = this.direct(), this.read(v) | 1);
		case 0x11: // BCLR0
			return this.write(v = this.direct(), this.read(v) & ~1);
		case 0x12: // BSET1
			return this.write(v = this.direct(), this.read(v) | 2);
		case 0x13: // BCLR1
			return this.write(v = this.direct(), this.read(v) & ~2);
		case 0x14: // BSET2
			return this.write(v = this.direct(), this.read(v) | 4);
		case 0x15: // BCLR2
			return this.write(v = this.direct(), this.read(v) & ~4);
		case 0x16: // BSET3
			return this.write(v = this.direct(), this.read(v) | 8);
		case 0x17: // BCLR3
			return this.write(v = this.direct(), this.read(v) & ~8);
		case 0x18: // BSET4
			return this.write(v = this.direct(), this.read(v) | 0x10);
		case 0x19: // BCLR4
			return this.write(v = this.direct(), this.read(v) & ~0x10);
		case 0x1a: // BSET5
			return this.write(v = this.direct(), this.read(v) | 0x20);
		case 0x1b: // BCLR5
			return this.write(v = this.direct(), this.read(v) & ~0x20);
		case 0x1c: // BSET6
			return this.write(v = this.direct(), this.read(v) | 0x40);
		case 0x1d: // BCLR6
			return this.write(v = this.direct(), this.read(v) & ~0x40);
		case 0x1e: // BSET7
			return this.write(v = this.direct(), this.read(v) | 0x80);
		case 0x1f: // BCLR7
			return this.write(v = this.direct(), this.read(v) & ~0x80);
		case 0x20: // BRA
		...
		case 0x27: // BEQ
			return this.bcc((this.ccr & 4) !== 0);
		case 0x28: // BHCC
			return this.bcc((this.ccr & 0x20) === 0);
		case 0x29: // BHCS
			return this.bcc((this.ccr & 0x20) !== 0);
		case 0x2a: // BPL
		...
		case 0x5d: // TSTX
			return this.tsta(this.x);
		case 0x5f: // CLRX
			return void(this.x = this.clra());
		case 0x60: // NEG n,X
			return this.neg(this.index1());
		case 0x63: // COM n,X
			return this.com(this.index1());
		case 0x64: // LSR n,X
			return this.lsr(this.index1());
		case 0x66: // ROR n,X
			return this.ror(this.index1());
		case 0x67: // ASR n,X
			return this.asr(this.index1());
		case 0x68: // ASL(LSL) n,X
			return this.lsl(this.index1());
		case 0x69: // ROL n,X
			return this.rol(this.index1());
		case 0x6a: // DEC n,X
			return this.dec(this.index1());
		case 0x6c: // INC n,X
			return this.inc(this.index1());
		case 0x6d: // TST n,X
			return this.tst(this.index1());
		case 0x6f: // CLR n,X
			return this.clr(this.index1());
		case 0x70: // NEG ,X
		...
		case 0xb3: // CPX <n
			return this.cmp(this.x, this.direct());
		case 0xb4: // AND <n
		...
		case 0xbf: // STX <n
			return this.st(this.x, this.direct());
		case 0xc0: // SUB >nn
		...
		case 0xc3: // CPX >nn
			return this.cmp(this.x, this.extend());
		case 0xc4: // AND >nn
		...
		case 0xed: // JSR n,X
			return this.jsr(this.index1());
		case 0xee: // LDX n,X
			return void(this.x = this.ld(this.index1()));
		case 0xef: // STX n,X
			return this.st(this.x, this.index1());
		case 0xf0: // SUB ,X
		...
		case 0xf3: // CPX ,X
			return this.cmp(this.x, this.index());
		case 0xf4: // AND ,X
		...
		case 0xff: // STX ,X
			return this.st(this.x, this.index());
		default:
			this.undefsize = 1;
			if (this.undef)
				this.undef(this.arg);
