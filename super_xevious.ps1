...
$prg1 = (expand sxeviousj/xv3_1.3p) + (expand sxeviousj/xv3_2.3m) + (expand sxevious/xv3_3.2m) + (expand sxevious/xv3_4.2l)
$prg2 = (expand sxevious/xv3_5.3f) + (expand sxevious/xv3_6.3j)
