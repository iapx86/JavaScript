/*
 *
 *	Downtown Nekketsu Monogatari (X68000)
 *
 */
...
import {ROM, DISK1, DISK2} from "./dist/downtown_nekketsu_monogatari_x68_rom.js";
...
window.addEventListener('load', () => expand(ROM).then(ROM => {
	...
	canvas.addEventListener('click', () => void game.keyboard.fifo.push(0x72, 0x80 | 0x72));
