...
class GenpeiToumaDen {
	...
	constructor() {
		...
		convert(this.bg1, BG1, 4096, rseq(8, 0, 16), [...rseq(4), ...rseq(4, 8)], [0, 4], 16);
		convert(this.bg1, BG1, 4096, rseq(8, 0, 8), rseq(8), [-1, -1, Math.floor(BG1.length / 3) * 16], 8);
		...
		convert(this.obj, OBJ, 2048, [...rseq(16, 2048, 64), ...rseq(16, 0, 64)],
