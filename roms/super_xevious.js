...
const prg1 = cat(z.read('sxeviousj/xv3_1.3p'), z.read('sxeviousj/xv3_2.3m'), z.read('sxevious/xv3_3.2m'), z.read('sxevious/xv3_4.2l'));
const prg2 = cat(z.read('sxevious/xv3_5.3f'), z.read('sxevious/xv3_6.3j'));
