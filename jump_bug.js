...
class JumpBug {
	...
	constructor() {
		...
		convert(this.bg.subarray(0x8000), BG.subarray(0x800), 512, rseq(8, 0, 8), rseq(8), [BG.length * 4, 0], 8);
		convert(this.obj, BG, 64, [...rseq(8, 128, 8), ...rseq(8, 0, 8)], [...rseq(8), ...rseq(8, 64)], [BG.length * 4, 0], 32);
		convert(this.obj.subarray(0x8000), BG.subarray(0x800), 128, [...rseq(8, 128, 8), ...rseq(8, 0, 8)], [...rseq(8), ...rseq(8, 64)], [BG.length * 4, 0], 32);
