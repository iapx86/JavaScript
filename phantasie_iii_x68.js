/*
 *
 *	Phantasie III (X68000)
 *
 */

import {init, expand} from './main.js';
import X68000, {SRAM, sound} from './x68000.js';
let game;
...
import {ROM, DISK1, DISK2, DISK3} from "./dist/phantasie_iii_x68.png.js";

SRAM.set(Uint8Array.from(window.atob('\
gnc2ODAwMFcAwAAAAL///ADtAQD/////knBuBwAQAAAAAP//AAAHAQ4ADQAAAAAA+D7/wP/+zahAIgMCAAgAAAAAAAAAAAAAAP/cAAQAAQEAAAAgAAn5AQAA\
...
window.addEventListener('load', () => expand(ROM).then(ROM => {
	...
	game.fdd.command.push({unit: 2, disk});
